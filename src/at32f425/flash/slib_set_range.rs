...
pub type SLIB_ISS_SET_W<'a, REG> = crate::FieldWriter<'a, REG, 11, u16>;
...
impl W {
    ...
    #[inline(always)]
    pub fn slib_ss_set(&mut self) -> SLIB_SS_SET_W<'_, SLIB_SET_RANGE_SPEC> {
        SLIB_SS_SET_W::new(self, 0)
    }
    #[doc = "Bits 11:21 - sLib instruction start sector setting"]
    #[inline(always)]
    pub fn slib_iss_set(&mut self) -> SLIB_ISS_SET_W<'_, SLIB_SET_RANGE_SPEC> {
        SLIB_ISS_SET_W::new(self, 11)
    }
    #[doc = "Bits 22:31 - sLib end sector setting"]
    #[inline(always)]
    pub fn slib_es_set(&mut self) -> SLIB_ES_SET_W<'_, SLIB_SET_RANGE_SPEC> {
