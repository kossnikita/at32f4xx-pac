...
pub type R = crate::R<C4MADDR_SPEC>;
#[doc = "Register `C4MADDR` writer"]
pub type W = crate::W<C4MADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn maddr(&mut self) -> MADDR_W<C4MADDR_SPEC, 0> {
        MADDR_W::new(self)
    }
...
pub struct C4MADDR_SPEC;
impl crate::RegisterSpec for C4MADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c4maddr::R`](R) reader structure"]
impl crate::Readable for C4MADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`c4maddr::W`](W) writer structure"]
impl crate::Writable for C4MADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C4MADDR to value 0"]
impl crate::Resettable for C4MADDR_SPEC {
