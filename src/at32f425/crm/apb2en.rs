...
#[doc = "Field `SCFGEN` reader - System config clock enable"]
pub type SCFGEN_R = crate::BitReader;
#[doc = "Field `SCFGEN` writer - System config clock enable"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scfgen(&mut self) -> SCFGEN_W<APB2EN_SPEC, 0> {
        SCFGEN_W::new(self)
    }
    #[doc = "Bit 9 - ADC1 clock enable"]
    #[inline(always)]
