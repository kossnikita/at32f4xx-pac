...
impl W {
    #[doc = "Bits 0:7 - XIP write second dummy cycle"]
    #[inline(always)]
    pub fn xipw_dum2(&mut self) -> XIPW_DUM2_W<'_, XIP_CMD_W1_SPEC> {
        XIPW_DUM2_W::new(self, 0)
    }
    #[doc = "Bits 8:10 - XIP write operate mode"]
    #[inline(always)]
    pub fn xipw_opmode(&mut self) -> XIPW_OPMODE_W<'_, XIP_CMD_W1_SPEC> {
        XIPW_OPMODE_W::new(self, 8)
    }
    #[doc = "Bit 11 - XIP write address length"]
    #[inline(always)]
    pub fn xipw_adrlen(&mut self) -> XIPW_ADRLEN_W<'_, XIP_CMD_W1_SPEC> {
        XIPW_ADRLEN_W::new(self, 11)
    }
    #[doc = "Bits 12:19 - XIP write instruction code"]
    #[inline(always)]
    pub fn xipw_insc(&mut self) -> XIPW_INSC_W<'_, XIP_CMD_W1_SPEC> {
