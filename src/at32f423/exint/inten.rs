...
pub type INTEN21_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type INTEN22_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type INTEN23_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type INTEN25_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type INTEN26_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type INTEN28_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn inten28(&mut self) -> INTEN28_W<INTEN_SPEC, 28> {
        INTEN28_W::new(self)
    }
