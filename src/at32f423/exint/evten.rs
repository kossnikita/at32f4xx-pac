...
pub type EVTEN23_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EVTEN25_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EVTEN26_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EVTEN28_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn evten23(&mut self) -> EVTEN23_W<EVTEN_SPEC, 23> {
        EVTEN23_W::new(self)
    }
    #[doc = "Bit 25 - Event enable or disable on line 25"]
    #[inline(always)]
    #[must_use]
    pub fn evten25(&mut self) -> EVTEN25_W<EVTEN_SPEC, 25> {
        EVTEN25_W::new(self)
    }
    #[doc = "Bit 26 - Event enable or disable on line 26"]
    #[inline(always)]
    #[must_use]
    pub fn evten26(&mut self) -> EVTEN26_W<EVTEN_SPEC, 26> {
        EVTEN26_W::new(self)
    }
    #[doc = "Bit 28 - Event enable or disable on line 28"]
    #[inline(always)]
    #[must_use]
    pub fn evten28(&mut self) -> EVTEN28_W<EVTEN_SPEC, 28> {
        EVTEN28_W::new(self)
    }
