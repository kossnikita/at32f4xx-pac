#![doc = "Peripheral access API for AT32F423 microcontrollers (generated using svd2rust v0.30.0 (ee3afce 2023-10-01))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            USB_OTGFS_HOST: USB_OTGFS_HOST {
                _marker: PhantomData,
            },
            USB_OTGFS_DEVICE: USB_OTGFS_DEVICE {
                _marker: PhantomData,
            },
            USB_OTGFS_PWRCLK: USB_OTGFS_PWRCLK {
                _marker: PhantomData,
            },
            SCFG: SCFG {
                _marker: PhantomData,
