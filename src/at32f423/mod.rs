#![doc = "Peripheral access API for AT32F423 microcontrollers (generated using svd2rust v0.33.4 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
#[doc = "USB on the go full speed"]
pub struct USB_OTGFS_HOST {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for USB_OTGFS_HOST {}
impl USB_OTGFS_HOST {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const usb_otgfs_host::RegisterBlock = 0x5000_0400 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const usb_otgfs_host::RegisterBlock {
        Self::PTR
    }
    #[doc = r" Steal an instance of this peripheral"]
    #[doc = r""]
...
impl Deref for USB_OTGFS_HOST {
    type Target = usb_otgfs_host::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
...
#[doc = "USB on the go full speed"]
pub struct USB_OTGFS_DEVICE {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for USB_OTGFS_DEVICE {}
impl USB_OTGFS_DEVICE {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const usb_otgfs_device::RegisterBlock = 0x5000_0800 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const usb_otgfs_device::RegisterBlock {
        Self::PTR
    }
    #[doc = r" Steal an instance of this peripheral"]
    #[doc = r""]
...
impl Deref for USB_OTGFS_DEVICE {
    type Target = usb_otgfs_device::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
...
#[doc = "USB on the go full speed"]
pub struct USB_OTGFS_PWRCLK {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for USB_OTGFS_PWRCLK {}
impl USB_OTGFS_PWRCLK {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const usb_otgfs_pwrclk::RegisterBlock = 0x5000_0e00 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const usb_otgfs_pwrclk::RegisterBlock {
        Self::PTR
    }
    #[doc = r" Steal an instance of this peripheral"]
    #[doc = r""]
...
impl Deref for USB_OTGFS_PWRCLK {
    type Target = usb_otgfs_pwrclk::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
