...
pub type R = crate::R<ALB_SPEC>;
#[doc = "Register `ALB` writer"]
pub type W = crate::W<ALB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn su(&mut self) -> SU_W<ALB_SPEC, 0> {
        SU_W::new(self)
    }
    #[doc = "Bits 4:6 - Second tens"]
    #[inline(always)]
    #[must_use]
    pub fn st(&mut self) -> ST_W<ALB_SPEC, 4> {
        ST_W::new(self)
    }
    #[doc = "Bit 7 - Seconds mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask1(&mut self) -> MASK1_W<ALB_SPEC, 7> {
        MASK1_W::new(self)
    }
    #[doc = "Bits 8:11 - Minute units"]
    #[inline(always)]
    #[must_use]
    pub fn mu(&mut self) -> MU_W<ALB_SPEC, 8> {
        MU_W::new(self)
    }
    #[doc = "Bits 12:14 - Minute tens"]
    #[inline(always)]
    #[must_use]
    pub fn mt(&mut self) -> MT_W<ALB_SPEC, 12> {
        MT_W::new(self)
    }
    #[doc = "Bit 15 - Minutes mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask2(&mut self) -> MASK2_W<ALB_SPEC, 15> {
        MASK2_W::new(self)
    }
    #[doc = "Bits 16:19 - Hour units"]
    #[inline(always)]
    #[must_use]
    pub fn hu(&mut self) -> HU_W<ALB_SPEC, 16> {
        HU_W::new(self)
    }
    #[doc = "Bits 20:21 - Hour tens"]
    #[inline(always)]
    #[must_use]
    pub fn ht(&mut self) -> HT_W<ALB_SPEC, 20> {
        HT_W::new(self)
    }
    #[doc = "Bit 22 - AM/PM"]
    #[inline(always)]
    #[must_use]
    pub fn ampm(&mut self) -> AMPM_W<ALB_SPEC, 22> {
        AMPM_W::new(self)
    }
    #[doc = "Bit 23 - Hours mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask3(&mut self) -> MASK3_W<ALB_SPEC, 23> {
        MASK3_W::new(self)
    }
    #[doc = "Bits 24:27 - Date units"]
    #[inline(always)]
    #[must_use]
    pub fn du(&mut self) -> DU_W<ALB_SPEC, 24> {
        DU_W::new(self)
    }
    #[doc = "Bits 28:29 - Date tens"]
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DT_W<ALB_SPEC, 28> {
        DT_W::new(self)
    }
    #[doc = "Bit 30 - Date/week mode select"]
    #[inline(always)]
    #[must_use]
    pub fn wksel(&mut self) -> WKSEL_W<ALB_SPEC, 30> {
        WKSEL_W::new(self)
    }
    #[doc = "Bit 31 - Date/week mask"]
    #[inline(always)]
    #[must_use]
    pub fn mask4(&mut self) -> MASK4_W<ALB_SPEC, 31> {
        MASK4_W::new(self)
    }
