...
pub type CCALEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OUTSEL_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, OUTSEL_A>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CTRL")
            ...
            .field("watien", &format_args!("{}", self.watien().bit()))
            .field("alaien", &format_args!("{}", self.alaien().bit()))
            .field("albien", &format_args!("{}", self.albien().bit()))
            .field("tsen", &format_args!("{}", self.tsen().bit()))
            .field("waten", &format_args!("{}", self.waten().bit()))
            .field("alaen", &format_args!("{}", self.alaen().bit()))
            .field("alben", &format_args!("{}", self.alben().bit()))
            ...
            .field("watclk", &format_args!("{}", self.watclk().bits()))
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccalen(&mut self) -> CCALEN_W<CTRL_SPEC, 7> {
        CCALEN_W::new(self)
    }
    #[doc = "Bit 8 - Alarm A enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn alben(&mut self) -> ALBEN_W<CTRL_SPEC, 9> {
        ALBEN_W::new(self)
    }
    #[doc = "Bit 10 - Wakeup timer enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn albien(&mut self) -> ALBIEN_W<CTRL_SPEC, 13> {
        ALBIEN_W::new(self)
    }
    #[doc = "Bit 14 - Wakeup timer interrupt enable"]
    #[inline(always)]
