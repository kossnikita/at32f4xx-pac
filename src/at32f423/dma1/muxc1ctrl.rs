...
pub type R = crate::R<MUXC1CTRL_SPEC>;
#[doc = "Register `MUXC1CTRL` writer"]
pub type W = crate::W<MUXC1CTRL_SPEC>;
...
impl W {
    #[doc = "Bits 0:6 - DMA request select"]
    #[inline(always)]
    pub fn reqsel(&mut self) -> REQSEL_W<'_, MUXC1CTRL_SPEC> {
        REQSEL_W::new(self, 0)
    }
    #[doc = "Bit 8 - Synchronization overrun interrupt enable"]
    #[inline(always)]
    pub fn syncovien(&mut self) -> SYNCOVIEN_W<'_, MUXC1CTRL_SPEC> {
        SYNCOVIEN_W::new(self, 8)
    }
    #[doc = "Bit 9 - Event generation enable"]
    #[inline(always)]
    pub fn evtgen(&mut self) -> EVTGEN_W<'_, MUXC1CTRL_SPEC> {
        EVTGEN_W::new(self, 9)
    }
    #[doc = "Bit 16 - Synchroniztion enable"]
    #[inline(always)]
    pub fn syncen(&mut self) -> SYNCEN_W<'_, MUXC1CTRL_SPEC> {
        SYNCEN_W::new(self, 16)
    }
    #[doc = "Bits 17:18 - Synchronization polarity"]
    #[inline(always)]
    pub fn syncpol(&mut self) -> SYNCPOL_W<'_, MUXC1CTRL_SPEC> {
        SYNCPOL_W::new(self, 17)
    }
    #[doc = "Bits 19:23 - Number of DMA requests"]
    #[inline(always)]
    pub fn reqcnt(&mut self) -> REQCNT_W<'_, MUXC1CTRL_SPEC> {
        REQCNT_W::new(self, 19)
    }
    #[doc = "Bits 24:28 - Synchronization Identification"]
    #[inline(always)]
    pub fn syncsel(&mut self) -> SYNCSEL_W<'_, MUXC1CTRL_SPEC> {
        SYNCSEL_W::new(self, 24)
    }
}
#[doc = "Channel 1 Configuration Register\n\nYou can [`read`](crate::Reg::read) this register and get [`muxc1ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`muxc1ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MUXC1CTRL_SPEC;
impl crate::RegisterSpec for MUXC1CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`muxc1ctrl::R`](R) reader structure"]
impl crate::Readable for MUXC1CTRL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`muxc1ctrl::W`](W) writer structure"]
impl crate::Writable for MUXC1CTRL_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets MUXC1CTRL to value 0"]
impl crate::Resettable for MUXC1CTRL_SPEC {}
