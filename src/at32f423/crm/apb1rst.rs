...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart5(&mut self) -> USART5_W<APB1RST_SPEC, 20> {
        USART5_W::new(self)
    }
    #[doc = "Bit 21 - I2C1 reset"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c3(&mut self) -> I2C3_W<APB1RST_SPEC, 23> {
        I2C3_W::new(self)
    }
    #[doc = "Bit 25 - CAN1 reset"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart7(&mut self) -> USART7_W<APB1RST_SPEC, 30> {
        USART7_W::new(self)
    }
    #[doc = "Bit 31 - USART8 reset"]
    #[inline(always)]
    #[must_use]
    pub fn usart8(&mut self) -> USART8_W<APB1RST_SPEC, 31> {
        USART8_W::new(self)
    }
