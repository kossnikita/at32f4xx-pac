...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmr12(&mut self) -> TMR12_W<APB1RST_SPEC> {
        TMR12_W::new(self, 6)
    }
    #[doc = "Bit 7 - Timer13 reset"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac(&mut self) -> DAC_W<APB1RST_SPEC> {
        DAC_W::new(self, 29)
    }
    #[doc = "Bit 30 - USART7 reset"]
    #[inline(always)]
    #[must_use]
    pub fn usart7(&mut self) -> USART7_W<APB1RST_SPEC> {
        USART7_W::new(self, 30)
    }
    #[doc = "Bit 31 - USART8 reset"]
    #[inline(always)]
    #[must_use]
    pub fn usart8(&mut self) -> USART8_W<APB1RST_SPEC> {
