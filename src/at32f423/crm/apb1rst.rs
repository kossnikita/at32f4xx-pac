...
#[doc = "Field `PWCRST` reader - PWC reset"]
pub type PWCRST_R = crate::BitReader;
#[doc = "Field `PWCRST` writer - PWC reset"]
...
pub type USART7RST_R = crate::BitReader;
#[doc = "Field `USART7RST` writer - USART7 reset"]
pub type USART7RST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USART8RST` reader - USART8 reset"]
pub type USART8RST_R = crate::BitReader;
#[doc = "Field `USART8RST` writer - USART8 reset"]
pub type USART8RST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    ...
    pub fn usart7rst(&self) -> USART7RST_R {
        USART7RST_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - USART8 reset"]
    #[inline(always)]
    pub fn usart8rst(&self) -> USART8RST_R {
        USART8RST_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Timer2 reset"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart5rst(&mut self) -> USART5RST_W<APB1RST_SPEC, 20> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c3rst(&mut self) -> I2C3RST_W<APB1RST_SPEC, 23> {
        I2C3RST_W::new(self)
    }
    #[doc = "Bit 25 - CAN1 reset"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn can2rst(&mut self) -> CAN2RST_W<APB1RST_SPEC, 26> {
        CAN2RST_W::new(self)
    }
    #[doc = "Bit 28 - PWC reset"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart7rst(&mut self) -> USART7RST_W<APB1RST_SPEC, 30> {
        USART7RST_W::new(self)
    }
    #[doc = "Bit 31 - USART8 reset"]
    #[inline(always)]
    #[must_use]
    pub fn usart8rst(&mut self) -> USART8RST_W<APB1RST_SPEC, 31> {
