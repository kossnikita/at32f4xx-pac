...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("APB1EN")
            ...
            .field("usart5", &format_args!("{}", self.usart5().bit()))
            ...
            .field("usart7", &format_args!("{}", self.usart7().bit()))
            .field("usart8", &format_args!("{}", self.usart8().bit()))
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart4(&mut self) -> USART4_W<APB1EN_SPEC> {
        USART4_W::new(self, 19)
    }
    #[doc = "Bit 20 - USART5 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart5(&mut self) -> USART5_W<APB1EN_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can2(&mut self) -> CAN2_W<APB1EN_SPEC> {
        CAN2_W::new(self, 26)
    }
    #[doc = "Bit 28 - PWC clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart7(&mut self) -> USART7_W<APB1EN_SPEC> {
        USART7_W::new(self, 30)
    }
    #[doc = "Bit 31 - USART8 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart8(&mut self) -> USART8_W<APB1EN_SPEC> {
