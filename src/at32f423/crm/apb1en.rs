...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart5en(&mut self) -> USART5EN_W<APB1EN_SPEC, 20> {
        USART5EN_W::new(self)
    }
    #[doc = "Bit 21 - I2C1 clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c3en(&mut self) -> I2C3EN_W<APB1EN_SPEC, 23> {
        I2C3EN_W::new(self)
    }
    #[doc = "Bit 25 - CAN1 clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn can2en(&mut self) -> CAN2EN_W<APB1EN_SPEC, 26> {
        CAN2EN_W::new(self)
    }
    #[doc = "Bit 28 - PWC clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart7en(&mut self) -> USART7EN_W<APB1EN_SPEC, 30> {
        USART7EN_W::new(self)
    }
    #[doc = "Bit 31 - USART8 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart8en(&mut self) -> USART8EN_W<APB1EN_SPEC, 31> {
        USART8EN_W::new(self)
    }
