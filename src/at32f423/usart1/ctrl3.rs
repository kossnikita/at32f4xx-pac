...
impl ERRIEN_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> ERRIENR_A {
        match self.bits {
...
impl IRDAEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> IRDAENR_A {
        match self.bits {
...
impl IRDALP_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> IRDALPR_A {
        match self.bits {
...
impl SCNACKEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> SCNACKENR_A {
        match self.bits {
...
impl SCMEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> SCMENR_A {
        match self.bits {
...
impl RTSEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> RTSENR_A {
        match self.bits {
...
impl CTSEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> CTSENR_A {
        match self.bits {
...
impl CTSCFIEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> CTSCFIENR_A {
        match self.bits {
...
pub type SMUSEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LPWUFIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `RS485EN` reader - RS485 enable"]
pub type RS485EN_R = crate::BitReader;
#[doc = "Field `RS485EN` writer - RS485 enable"]
pub type RS485EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LPWUM_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn smusen(&mut self) -> SMUSEN_W<CTRL3_SPEC, 11> {
        SMUSEN_W::new(self)
    }
    #[doc = "Bit 13 - Low power wakeup flag interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn lpwufie(&mut self) -> LPWUFIE_W<CTRL3_SPEC, 13> {
        LPWUFIE_W::new(self)
    }
    #[doc = "Bit 14 - RS485 enable"]
    #[inline(always)]
    #[must_use]
    pub fn rs485en(&mut self) -> RS485EN_W<CTRL3_SPEC, 14> {
        RS485EN_W::new(self)
    }
    #[doc = "Bit 15 - DE polarity selection"]
    #[inline(always)]
    #[must_use]
    pub fn dep(&mut self) -> DEP_W<CTRL3_SPEC, 15> {
        DEP_W::new(self)
    }
    #[doc = "Bits 16:17 - Low power wakeup method"]
    #[inline(always)]
    #[must_use]
    pub fn lpwum(&mut self) -> LPWUM_W<CTRL3_SPEC, 16> {
        LPWUM_W::new(self)
    }
