...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn idl(&mut self) -> IDL_W<CTRL2_SPEC> {
        IDL_W::new(self, 0)
    }
    #[doc = "Bit 4 - Identification bit num"]
    #[inline(always)]
    #[must_use]
    pub fn idbn(&mut self) -> IDBN_W<CTRL2_SPEC> {
        IDBN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Break frame bit num"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxrev(&mut self) -> RXREV_W<CTRL2_SPEC> {
        RXREV_W::new(self, 16)
    }
    #[doc = "Bit 17 - TX polarity reverse"]
    #[inline(always)]
    #[must_use]
    pub fn txrev(&mut self) -> TXREV_W<CTRL2_SPEC> {
        TXREV_W::new(self, 17)
    }
    #[doc = "Bit 18 - DT register polarity reverse"]
    #[inline(always)]
    #[must_use]
    pub fn dtrev(&mut self) -> DTREV_W<CTRL2_SPEC> {
        DTREV_W::new(self, 18)
    }
    #[doc = "Bit 19 - MSB transmit first"]
    #[inline(always)]
    #[must_use]
    pub fn mtf(&mut self) -> MTF_W<CTRL2_SPEC> {
        MTF_W::new(self, 19)
    }
    #[doc = "Bits 28:31 - bit 7-4 for usart identification"]
    #[inline(always)]
    #[must_use]
    pub fn idh(&mut self) -> IDH_W<CTRL2_SPEC> {
        IDH_W::new(self, 28)
    }
}
