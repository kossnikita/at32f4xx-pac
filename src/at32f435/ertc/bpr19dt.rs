...
pub type R = crate::R<BPR19DT_SPEC>;
#[doc = "Register `BPR19DT` writer"]
pub type W = crate::W<BPR19DT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DT_W<BPR19DT_SPEC, 0> {
        DT_W::new(self)
    }
...
pub struct BPR19DT_SPEC;
impl crate::RegisterSpec for BPR19DT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bpr19dt::R`](R) reader structure"]
impl crate::Readable for BPR19DT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`bpr19dt::W`](W) writer structure"]
impl crate::Writable for BPR19DT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets BPR19DT to value 0"]
impl crate::Resettable for BPR19DT_SPEC {
