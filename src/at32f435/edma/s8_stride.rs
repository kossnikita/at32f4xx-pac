...
pub type R = crate::R<S8_STRIDE_SPEC>;
#[doc = "Register `S8_STRIDE` writer"]
pub type W = crate::W<S8_STRIDE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srcstd(&mut self) -> SRCSTD_W<S8_STRIDE_SPEC, 0> {
        SRCSTD_W::new(self)
    }
    #[doc = "Bits 16:31 - Destination stride"]
    #[inline(always)]
    #[must_use]
    pub fn dststd(&mut self) -> DSTSTD_W<S8_STRIDE_SPEC, 16> {
        DSTSTD_W::new(self)
    }
...
impl crate::Readable for S8_STRIDE_SPEC {}
#[doc = "`write(|w| ..)` method takes [`s8_stride::W`](W) writer structure"]
impl crate::Writable for S8_STRIDE_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets S8_STRIDE to value 0"]
impl crate::Resettable for S8_STRIDE_SPEC {
