...
pub type R = crate::R<S3_STRIDE_SPEC>;
#[doc = "Register `S3_STRIDE` writer"]
pub type W = crate::W<S3_STRIDE_SPEC>;
...
#[doc = "Stream 3 2D Transfer Stride\n\nYou can [`read`](crate::Reg::read) this register and get [`s3_stride::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s3_stride::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S3_STRIDE_SPEC;
impl crate::RegisterSpec for S3_STRIDE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s3_stride::R`](R) reader structure"]
impl crate::Readable for S3_STRIDE_SPEC {}
