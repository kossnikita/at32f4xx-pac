...
impl W {
    #[doc = "Bit 0 - Stream enable / flag stream ready when read low"]
    #[inline(always)]
    pub fn sen(&mut self) -> SEN_W<'_, S1CTRL_SPEC> {
        SEN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Direct mode error interrupt enable"]
    #[inline(always)]
    pub fn dmerrien(&mut self) -> DMERRIEN_W<'_, S1CTRL_SPEC> {
        DMERRIEN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Transfer error interrupt enable"]
    #[inline(always)]
    pub fn dterrien(&mut self) -> DTERRIEN_W<'_, S1CTRL_SPEC> {
        DTERRIEN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Half data transfer interrupt enable"]
    #[inline(always)]
    pub fn hdtien(&mut self) -> HDTIEN_W<'_, S1CTRL_SPEC> {
        HDTIEN_W::new(self, 3)
    }
    #[doc = "Bit 4 - Full data transfer complete interrupt enable"]
    #[inline(always)]
    pub fn fdtien(&mut self) -> FDTIEN_W<'_, S1CTRL_SPEC> {
        FDTIEN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Peripheral flow controller"]
    #[inline(always)]
    pub fn pfctrl(&mut self) -> PFCTRL_W<'_, S1CTRL_SPEC> {
        PFCTRL_W::new(self, 5)
    }
    #[doc = "Bits 6:7 - Data transfer direction"]
    #[inline(always)]
    pub fn dtd(&mut self) -> DTD_W<'_, S1CTRL_SPEC> {
        DTD_W::new(self, 6)
    }
    #[doc = "Bit 8 - Loop mode"]
    #[inline(always)]
    pub fn lm(&mut self) -> LM_W<'_, S1CTRL_SPEC> {
        LM_W::new(self, 8)
    }
    #[doc = "Bit 9 - Peripheral increment mode"]
    #[inline(always)]
    pub fn pincm(&mut self) -> PINCM_W<'_, S1CTRL_SPEC> {
        PINCM_W::new(self, 9)
    }
    #[doc = "Bit 10 - Memory increment mode"]
    #[inline(always)]
    pub fn mincm(&mut self) -> MINCM_W<'_, S1CTRL_SPEC> {
        MINCM_W::new(self, 10)
    }
    #[doc = "Bits 11:12 - Peripheral data width"]
    #[inline(always)]
    pub fn pwidth(&mut self) -> PWIDTH_W<'_, S1CTRL_SPEC> {
        PWIDTH_W::new(self, 11)
    }
    #[doc = "Bits 13:14 - Memory data width"]
    #[inline(always)]
    pub fn mwidth(&mut self) -> MWIDTH_W<'_, S1CTRL_SPEC> {
        MWIDTH_W::new(self, 13)
    }
    #[doc = "Bit 15 - Peripheral increment offset size"]
    #[inline(always)]
    pub fn pincos(&mut self) -> PINCOS_W<'_, S1CTRL_SPEC> {
        PINCOS_W::new(self, 15)
    }
    #[doc = "Bits 16:17 - Stream priority level"]
    #[inline(always)]
    pub fn spl(&mut self) -> SPL_W<'_, S1CTRL_SPEC> {
        SPL_W::new(self, 16)
    }
    #[doc = "Bit 18 - Double memory mode"]
    #[inline(always)]
    pub fn dmm(&mut self) -> DMM_W<'_, S1CTRL_SPEC> {
        DMM_W::new(self, 18)
    }
    #[doc = "Bit 19 - Current memory (only in double buffer mode)"]
    #[inline(always)]
    pub fn cm(&mut self) -> CM_W<'_, S1CTRL_SPEC> {
        CM_W::new(self, 19)
    }
    #[doc = "Bits 21:22 - Peripheral burst transmission"]
    #[inline(always)]
    pub fn pburst(&mut self) -> PBURST_W<'_, S1CTRL_SPEC> {
        PBURST_W::new(self, 21)
    }
    #[doc = "Bits 23:24 - Memory burst transmission"]
    #[inline(always)]
    pub fn mburst(&mut self) -> MBURST_W<'_, S1CTRL_SPEC> {
