...
impl W {
    #[doc = "Bits 0:15 - X dimension transfer count"]
    #[inline(always)]
    pub fn xconut(&mut self) -> XCONUT_W<'_, S5_2DCNT_SPEC> {
        XCONUT_W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Y dimension transfer count"]
    #[inline(always)]
    pub fn yconut(&mut self) -> YCONUT_W<'_, S5_2DCNT_SPEC> {
        YCONUT_W::new(self, 16)
    }
}
#[doc = "Stream 5 2D Transfer Count\n\nYou can [`read`](crate::Reg::read) this register and get [`s5_2dcnt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s5_2dcnt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
