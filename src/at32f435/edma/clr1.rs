...
pub type FERRFC1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMERRFC1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FERRFC2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMERRFC2_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FERRFC3_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMERRFC3_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FERRFC4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMERRFC4_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ferrfc1(&mut self) -> FERRFC1_W<CLR1_SPEC, 0> {
        FERRFC1_W::new(self)
    }
    #[doc = "Bit 2 - Stream 1 clear direct mode error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrfc1(&mut self) -> DMERRFC1_W<CLR1_SPEC, 2> {
        DMERRFC1_W::new(self)
    }
    #[doc = "Bit 3 - Stream 1 clear transfer error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc1(&mut self) -> DTERRFC1_W<CLR1_SPEC, 3> {
        DTERRFC1_W::new(self)
    }
    #[doc = "Bit 4 - Stream 1 clear half data transfer interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc1(&mut self) -> HDTFC1_W<CLR1_SPEC, 4> {
        HDTFC1_W::new(self)
    }
    #[doc = "Bit 5 - Stream 1 clear full data transfer complete interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc1(&mut self) -> FDTFC1_W<CLR1_SPEC, 5> {
        FDTFC1_W::new(self)
    }
    #[doc = "Bit 6 - Stream 2 clear FIFO error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ferrfc2(&mut self) -> FERRFC2_W<CLR1_SPEC, 6> {
        FERRFC2_W::new(self)
    }
    #[doc = "Bit 8 - Stream 2 clear direct mode error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrfc2(&mut self) -> DMERRFC2_W<CLR1_SPEC, 8> {
        DMERRFC2_W::new(self)
    }
    #[doc = "Bit 9 - Stream 2 clear transfer error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc2(&mut self) -> DTERRFC2_W<CLR1_SPEC, 9> {
        DTERRFC2_W::new(self)
    }
    #[doc = "Bit 10 - Stream 2 clear half data transfer interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc2(&mut self) -> HDTFC2_W<CLR1_SPEC, 10> {
        HDTFC2_W::new(self)
    }
    #[doc = "Bit 11 - Stream 2 clear full data transfer complete interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc2(&mut self) -> FDTFC2_W<CLR1_SPEC, 11> {
        FDTFC2_W::new(self)
    }
    #[doc = "Bit 16 - Stream 3 clear FIFO error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ferrfc3(&mut self) -> FERRFC3_W<CLR1_SPEC, 16> {
        FERRFC3_W::new(self)
    }
    #[doc = "Bit 18 - Stream 3 clear direct mode error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrfc3(&mut self) -> DMERRFC3_W<CLR1_SPEC, 18> {
        DMERRFC3_W::new(self)
    }
    #[doc = "Bit 19 - Stream 3 clear transfer error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc3(&mut self) -> DTERRFC3_W<CLR1_SPEC, 19> {
        DTERRFC3_W::new(self)
    }
    #[doc = "Bit 20 - Stream 3 clear half data transfer interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc3(&mut self) -> HDTFC3_W<CLR1_SPEC, 20> {
        HDTFC3_W::new(self)
    }
    #[doc = "Bit 21 - Stream 3 clear full data transfer complete interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc3(&mut self) -> FDTFC3_W<CLR1_SPEC, 21> {
        FDTFC3_W::new(self)
    }
    #[doc = "Bit 22 - Stream 4 clear FIFO error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ferrfc4(&mut self) -> FERRFC4_W<CLR1_SPEC, 22> {
        FERRFC4_W::new(self)
    }
    #[doc = "Bit 24 - Stream 4 clear direct mode error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrfc4(&mut self) -> DMERRFC4_W<CLR1_SPEC, 24> {
        DMERRFC4_W::new(self)
    }
    #[doc = "Bit 25 - Stream 4 clear transfer error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc4(&mut self) -> DTERRFC4_W<CLR1_SPEC, 25> {
        DTERRFC4_W::new(self)
    }
    #[doc = "Bit 26 - Stream 4 clear half data transfer interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc4(&mut self) -> HDTFC4_W<CLR1_SPEC, 26> {
        HDTFC4_W::new(self)
    }
    #[doc = "Bit 27 - Stream 4 clear full data transfer complete interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc4(&mut self) -> FDTFC4_W<CLR1_SPEC, 27> {
        FDTFC4_W::new(self)
    }
