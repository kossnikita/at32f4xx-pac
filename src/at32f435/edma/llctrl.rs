...
pub type S1LLEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S2LLEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S3LLEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S4LLEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S5LLEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S6LLEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S7LLEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S8LLEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn s1llen(&mut self) -> S1LLEN_W<LLCTRL_SPEC, 0> {
        S1LLEN_W::new(self)
    }
    #[doc = "Bit 1 - Stream 2 link list enable"]
    #[inline(always)]
    #[must_use]
    pub fn s2llen(&mut self) -> S2LLEN_W<LLCTRL_SPEC, 1> {
        S2LLEN_W::new(self)
    }
    #[doc = "Bit 2 - Stream 3 link list enable"]
    #[inline(always)]
    #[must_use]
    pub fn s3llen(&mut self) -> S3LLEN_W<LLCTRL_SPEC, 2> {
        S3LLEN_W::new(self)
    }
    #[doc = "Bit 3 - Stream 4 link list enable"]
    #[inline(always)]
    #[must_use]
    pub fn s4llen(&mut self) -> S4LLEN_W<LLCTRL_SPEC, 3> {
        S4LLEN_W::new(self)
    }
    #[doc = "Bit 4 - Stream 5 link list enable"]
    #[inline(always)]
    #[must_use]
    pub fn s5llen(&mut self) -> S5LLEN_W<LLCTRL_SPEC, 4> {
        S5LLEN_W::new(self)
    }
    #[doc = "Bit 5 - Stream 6 link list enable"]
    #[inline(always)]
    #[must_use]
    pub fn s6llen(&mut self) -> S6LLEN_W<LLCTRL_SPEC, 5> {
        S6LLEN_W::new(self)
    }
    #[doc = "Bit 6 - Stream 7 link list enable"]
    #[inline(always)]
    #[must_use]
    pub fn s7llen(&mut self) -> S7LLEN_W<LLCTRL_SPEC, 6> {
        S7LLEN_W::new(self)
    }
    #[doc = "Bit 7 - Stream 8 link list enable"]
    #[inline(always)]
    #[must_use]
    pub fn s8llen(&mut self) -> S8LLEN_W<LLCTRL_SPEC, 7> {
        S8LLEN_W::new(self)
    }
