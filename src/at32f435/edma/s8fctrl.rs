...
pub type R = crate::R<S8FCTRL_SPEC>;
#[doc = "Register `S8FCTRL` writer"]
pub type W = crate::W<S8FCTRL_SPEC>;
...
impl W {
    #[doc = "Bits 0:1 - FIFO threshold selection"]
    #[inline(always)]
    pub fn fthsel(&mut self) -> FTHSEL_W<'_, S8FCTRL_SPEC> {
        FTHSEL_W::new(self, 0)
    }
    #[doc = "Bit 2 - FIFO mode enable"]
    #[inline(always)]
    pub fn fen(&mut self) -> FEN_W<'_, S8FCTRL_SPEC> {
        FEN_W::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    pub fn ferrien(&mut self) -> FERRIEN_W<'_, S8FCTRL_SPEC> {
        FERRIEN_W::new(self, 7)
    }
}
#[doc = "stream 8 FIFO control register\n\nYou can [`read`](crate::Reg::read) this register and get [`s8fctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s8fctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S8FCTRL_SPEC;
impl crate::RegisterSpec for S8FCTRL_SPEC {
    type Ux = u32;
}
