...
pub type R = crate::R<MUXS4CTRL_SPEC>;
#[doc = "Register `MUXS4CTRL` writer"]
pub type W = crate::W<MUXS4CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reqsel(&mut self) -> REQSEL_W<MUXS4CTRL_SPEC, 0> {
        REQSEL_W::new(self)
    }
    #[doc = "Bit 8 - Synchronization overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncovien(&mut self) -> SYNCOVIEN_W<MUXS4CTRL_SPEC, 8> {
        SYNCOVIEN_W::new(self)
    }
    #[doc = "Bit 9 - Event generation enable"]
    #[inline(always)]
    #[must_use]
    pub fn evtgen(&mut self) -> EVTGEN_W<MUXS4CTRL_SPEC, 9> {
        EVTGEN_W::new(self)
    }
    #[doc = "Bit 16 - Synchroniztion enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncen(&mut self) -> SYNCEN_W<MUXS4CTRL_SPEC, 16> {
        SYNCEN_W::new(self)
    }
    #[doc = "Bits 17:18 - Synchronization polarity"]
    #[inline(always)]
    #[must_use]
    pub fn syncpol(&mut self) -> SYNCPOL_W<MUXS4CTRL_SPEC, 17> {
        SYNCPOL_W::new(self)
    }
    #[doc = "Bits 19:23 - Number of DMA requests"]
    #[inline(always)]
    #[must_use]
    pub fn reqcnt(&mut self) -> REQCNT_W<MUXS4CTRL_SPEC, 19> {
        REQCNT_W::new(self)
    }
    #[doc = "Bits 24:28 - Synchronization select"]
    #[inline(always)]
    #[must_use]
    pub fn syncsel(&mut self) -> SYNCSEL_W<MUXS4CTRL_SPEC, 24> {
        SYNCSEL_W::new(self)
    }
...
impl crate::Readable for MUXS4CTRL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`muxs4ctrl::W`](W) writer structure"]
impl crate::Writable for MUXS4CTRL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MUXS4CTRL to value 0"]
impl crate::Resettable for MUXS4CTRL_SPEC {
