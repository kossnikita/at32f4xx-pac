...
impl W {
    #[doc = "Bits 0:31 - Memory 0 address"]
    #[inline(always)]
    pub fn m0addr(&mut self) -> M0ADDR_W<'_, S6M0ADDR_SPEC> {
        M0ADDR_W::new(self, 0)
    }
}
#[doc = "stream 6 memory 0 address register\n\nYou can [`read`](crate::Reg::read) this register and get [`s6m0addr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s6m0addr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
