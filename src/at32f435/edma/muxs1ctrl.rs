...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn reqsel(&mut self) -> REQSEL_W<MUXS1CTRL_SPEC, 0> {
        REQSEL_W::new(self)
    }
    #[doc = "Bit 8 - Synchronization overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncovien(&mut self) -> SYNCOVIEN_W<MUXS1CTRL_SPEC, 8> {
        SYNCOVIEN_W::new(self)
    }
    #[doc = "Bit 9 - Event generation enable"]
    #[inline(always)]
    #[must_use]
    pub fn evtgen(&mut self) -> EVTGEN_W<MUXS1CTRL_SPEC, 9> {
        EVTGEN_W::new(self)
    }
    #[doc = "Bit 16 - Synchroniztion enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncen(&mut self) -> SYNCEN_W<MUXS1CTRL_SPEC, 16> {
        SYNCEN_W::new(self)
    }
    #[doc = "Bits 17:18 - Synchronization polarity"]
    #[inline(always)]
    #[must_use]
    pub fn syncpol(&mut self) -> SYNCPOL_W<MUXS1CTRL_SPEC, 17> {
        SYNCPOL_W::new(self)
    }
    #[doc = "Bits 19:23 - Number of DMA requests"]
    #[inline(always)]
    #[must_use]
    pub fn reqcnt(&mut self) -> REQCNT_W<MUXS1CTRL_SPEC, 19> {
        REQCNT_W::new(self)
    }
    #[doc = "Bits 24:28 - Synchronization select"]
    #[inline(always)]
    #[must_use]
    pub fn syncsel(&mut self) -> SYNCSEL_W<MUXS1CTRL_SPEC, 24> {
        SYNCSEL_W::new(self)
    }
