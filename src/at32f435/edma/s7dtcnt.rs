...
impl W {
    #[doc = "Bits 0:15 - Number of data items to transfer"]
    #[inline(always)]
    pub fn cnt(&mut self) -> CNT_W<'_, S7DTCNT_SPEC> {
        CNT_W::new(self, 0)
    }
}
#[doc = "stream 7 number of data register\n\nYou can [`read`](crate::Reg::read) this register and get [`s7dtcnt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s7dtcnt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
