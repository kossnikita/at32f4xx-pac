...
impl W {
    ...
    #[inline(always)]
    pub fn slib_ss_set(&mut self) -> SLIB_SS_SET_W<'_, SLIB_SET_RANGE0_SPEC> {
        SLIB_SS_SET_W::new(self, 0)
    }
    #[doc = "Bits 16:31 - sLib end sector setting"]
    #[inline(always)]
    pub fn slib_es_set(&mut self) -> SLIB_ES_SET_W<'_, SLIB_SET_RANGE0_SPEC> {
        SLIB_ES_SET_W::new(self, 16)
    }
}
#[doc = "Configure sLib range register 0\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`slib_set_range0::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
