...
impl W {
    ...
    #[doc = "Bit 1 - Timer8 clock enable during sleep mode"]
    #[inline(always)]
    pub fn tmr8lpen(&mut self) -> TMR8LPEN_W<'_, APB2LPEN_SPEC> {
    ...
    #[doc = "Bit 13 - SPI4 clock enable during sleep mode"]
    #[inline(always)]
    pub fn spi4lpen(&mut self) -> SPI4LPEN_W<'_, APB2LPEN_SPEC> {
    ...
    #[doc = "Bit 20 - Timer20 clock enable during sleep mode"]
    #[inline(always)]
    pub fn tmr20lpen(&mut self) -> TMR20LPEN_W<'_, APB2LPEN_SPEC> {
