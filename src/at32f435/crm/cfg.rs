...
pub type CLKOUT1_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type CLKOUT1DIV1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type CLKOUT2DIV1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type CLKOUT2_SEL1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CFG")
            ...
            .field(
                "clkout1_sel",
                &format_args!("{}", self.clkout1_sel().bits()),
            )
            .field(
                "clkout1div1",
                &format_args!("{}", self.clkout1div1().bits()),
            )
            .field(
                "clkout2div1",
                &format_args!("{}", self.clkout2div1().bits()),
            )
            .field(
                "clkout2_sel1",
                &format_args!("{}", self.clkout2_sel1().bits()),
            )
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clkout1_sel(&mut self) -> CLKOUT1_SEL_W<CFG_SPEC, 21> {
        CLKOUT1_SEL_W::new(self)
    }
    #[doc = "Bits 24:26 - Clock output1 division1"]
    #[inline(always)]
    #[must_use]
    pub fn clkout1div1(&mut self) -> CLKOUT1DIV1_W<CFG_SPEC, 24> {
        CLKOUT1DIV1_W::new(self)
    }
    #[doc = "Bits 27:29 - Clock output2 division1"]
    #[inline(always)]
    #[must_use]
    pub fn clkout2div1(&mut self) -> CLKOUT2DIV1_W<CFG_SPEC, 27> {
        CLKOUT2DIV1_W::new(self)
    }
    #[doc = "Bits 30:31 - Clock output2 selection1"]
    #[inline(always)]
    #[must_use]
    pub fn clkout2_sel1(&mut self) -> CLKOUT2_SEL1_W<CFG_SPEC, 30> {
        CLKOUT2_SEL1_W::new(self)
    }
