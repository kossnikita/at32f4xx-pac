...
#[doc = "Field `TMR5RST` reader - Timer5 reset"]
pub type TMR5RST_R = crate::BitReader;
#[doc = "Field `TMR5RST` writer - Timer5 reset"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uart7rst(&mut self) -> UART7RST_W<APB1RST_SPEC, 30> {
        UART7RST_W::new(self)
    }
    #[doc = "Bit 31 - UART8 reset"]
    #[inline(always)]
    #[must_use]
    pub fn uart8rst(&mut self) -> UART8RST_W<APB1RST_SPEC, 31> {
        UART8RST_W::new(self)
    }
