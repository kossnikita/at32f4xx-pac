...
pub type OCCEIEN_R = crate::BitReader<OCCEIENR_A>;
...
impl From<OCCEIENR_A> for bool {
    #[inline(always)]
    fn from(variant: OCCEIENR_A) -> Self {
        variant as u8 != 0
    }
}
impl OCCEIEN_R {
    ...
    pub fn is_disabled(&self) -> bool {
        *self == OCCEIENR_A::Disabled
    }
    #[doc = "Channel conversion end interrupt is enabled"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == OCCEIENR_A::Enabled
    }
}
#[doc = "Ordinary channel conversion end interrupt enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum OCCEIENW_AW {
    #[doc = "0: Channel conversion end interrupt disable"]
    Disable = 0,
    #[doc = "1: Channel conversion end interrupt enable"]
    Enable = 1,
}
impl From<OCCEIENW_AW> for bool {
    #[inline(always)]
    fn from(variant: OCCEIENW_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `OCCEIEN` writer - Ordinary channel conversion end interrupt enable"]
pub type OCCEIEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, OCCEIENW_AW>;
impl<'a, REG, const O: u8> OCCEIEN_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disable(self) -> &'a mut crate::W<REG> {
        self.variant(OCCEIENW_AW::Disable)
    }
    #[doc = "Channel conversion end interrupt enable"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut crate::W<REG> {
        self.variant(OCCEIENW_AW::Enable)
    }
}
...
pub type CRSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type OCCOIEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn occeien(&mut self) -> OCCEIEN_W<CTRL1_SPEC, 5> {
        OCCEIEN_W::new(self)
    }
    #[doc = "Bit 6 - Voltage monitoring out of range interrupt enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn crsel(&mut self) -> CRSEL_W<CTRL1_SPEC, 24> {
        CRSEL_W::new(self)
    }
    #[doc = "Bit 26 - Ordinary channel conversion overflow interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn occoien(&mut self) -> OCCOIEN_W<CTRL1_SPEC, 26> {
        OCCOIEN_W::new(self)
    }
