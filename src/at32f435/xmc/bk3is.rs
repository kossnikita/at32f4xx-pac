...
impl core::fmt::Debug for crate::generic::Reg<BK3IS_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn res(&mut self) -> RES_W<BK3IS_SPEC, 0> {
        RES_W::new(self)
    }
    #[doc = "Bit 1 - High-level status"]
    #[inline(always)]
    #[must_use]
    pub fn hls(&mut self) -> HLS_W<BK3IS_SPEC, 1> {
        HLS_W::new(self)
    }
    #[doc = "Bit 2 - Falling edge status"]
    #[inline(always)]
    #[must_use]
    pub fn fes(&mut self) -> FES_W<BK3IS_SPEC, 2> {
        FES_W::new(self)
    }
    #[doc = "Bit 3 - Rising edge interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn reien(&mut self) -> REIEN_W<BK3IS_SPEC, 3> {
        REIEN_W::new(self)
    }
    #[doc = "Bit 4 - High-level interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn hlien(&mut self) -> HLIEN_W<BK3IS_SPEC, 4> {
        HLIEN_W::new(self)
    }
    #[doc = "Bit 5 - Falling edge interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn feien(&mut self) -> FEIEN_W<BK3IS_SPEC, 5> {
        FEIEN_W::new(self)
    }
