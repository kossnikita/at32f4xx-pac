...
impl W {
    #[doc = "Bits 0:3 - Mode register program to active delay"]
    #[inline(always)]
    pub fn tmrd(&mut self) -> TMRD_W<'_, TM1_SPEC> {
        TMRD_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Exit Self-refresh to active delay"]
    #[inline(always)]
    pub fn txsr(&mut self) -> TXSR_W<'_, TM1_SPEC> {
        TXSR_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Self refresh time"]
    #[inline(always)]
    pub fn tras(&mut self) -> TRAS_W<'_, TM1_SPEC> {
        TRAS_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Refresh to active delay"]
    #[inline(always)]
    pub fn trc(&mut self) -> TRC_W<'_, TM1_SPEC> {
        TRC_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - Write Recovery delay"]
    #[inline(always)]
    pub fn twr(&mut self) -> TWR_W<'_, TM1_SPEC> {
        TWR_W::new(self, 16)
    }
    #[doc = "Bits 20:23 - Precharge to active delay"]
    #[inline(always)]
    pub fn trp(&mut self) -> TRP_W<'_, TM1_SPEC> {
        TRP_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - Row active to Read/Write delay"]
    #[inline(always)]
    pub fn trcd(&mut self) -> TRCD_W<'_, TM1_SPEC> {
        TRCD_W::new(self, 24)
    }
}
#[doc = "SDRAM Timing register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`tm1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tm1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TM1_SPEC;
