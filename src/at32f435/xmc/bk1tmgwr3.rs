...
pub type R = crate::R<BK1TMGWR3_SPEC>;
#[doc = "Register `BK1TMGWR3` writer"]
pub type W = crate::W<BK1TMGWR3_SPEC>;
...
impl W {
    #[doc = "Bits 0:3 - Address setup time"]
    #[inline(always)]
    pub fn addrst(&mut self) -> ADDRST_W<'_, BK1TMGWR3_SPEC> {
        ADDRST_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Address-hold time"]
    #[inline(always)]
    pub fn addrht(&mut self) -> ADDRHT_W<'_, BK1TMGWR3_SPEC> {
        ADDRHT_W::new(self, 4)
    }
    #[doc = "Bits 8:15 - Asynchronous data setup time"]
    #[inline(always)]
    pub fn dtst(&mut self) -> DTST_W<'_, BK1TMGWR3_SPEC> {
        DTST_W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Bus latency"]
    #[inline(always)]
    pub fn buslat(&mut self) -> BUSLAT_W<'_, BK1TMGWR3_SPEC> {
        BUSLAT_W::new(self, 16)
    }
    #[doc = "Bits 28:29 - Asynchronous mode"]
    #[inline(always)]
    pub fn asyncm(&mut self) -> ASYNCM_W<'_, BK1TMGWR3_SPEC> {
        ASYNCM_W::new(self, 28)
    }
}
#[doc = "SRAM/NOR-Flash write timing registers 3\n\nYou can [`read`](crate::Reg::read) this register and get [`bk1tmgwr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bk1tmgwr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BK1TMGWR3_SPEC;
impl crate::RegisterSpec for BK1TMGWR3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bk1tmgwr3::R`](R) reader structure"]
impl crate::Readable for BK1TMGWR3_SPEC {}
#[doc = "`write(|w| ..)` method takes [`bk1tmgwr3::W`](W) writer structure"]
impl crate::Writable for BK1TMGWR3_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BK1TMGWR3 to value 0x0fff_ffff"]
impl crate::Resettable for BK1TMGWR3_SPEC {
