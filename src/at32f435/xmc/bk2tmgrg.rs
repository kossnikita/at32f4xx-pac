...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rgst(&mut self) -> RGST_W<BK2TMGRG_SPEC, 0> {
        RGST_W::new(self)
    }
    #[doc = "Bits 8:15 - Regular memory wait time"]
    #[inline(always)]
    #[must_use]
    pub fn rgwt(&mut self) -> RGWT_W<BK2TMGRG_SPEC, 8> {
        RGWT_W::new(self)
    }
    #[doc = "Bits 16:23 - Regular memory hold time"]
    #[inline(always)]
    #[must_use]
    pub fn rght(&mut self) -> RGHT_W<BK2TMGRG_SPEC, 16> {
        RGHT_W::new(self)
    }
    #[doc = "Bits 24:31 - Regular memory databus High resistance time"]
    #[inline(always)]
    #[must_use]
    pub fn rgdhizt(&mut self) -> RGDHIZT_W<BK2TMGRG_SPEC, 24> {
        RGDHIZT_W::new(self)
    }
