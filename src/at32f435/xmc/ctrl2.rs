...
impl W {
    #[doc = "Bits 0:1 - Number of column address bits"]
    #[inline(always)]
    pub fn ca(&mut self) -> CA_W<'_, CTRL2_SPEC> {
        CA_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Number of row address bits"]
    #[inline(always)]
    pub fn ra(&mut self) -> RA_W<'_, CTRL2_SPEC> {
        RA_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Memory data bus width"]
    #[inline(always)]
    pub fn db(&mut self) -> DB_W<'_, CTRL2_SPEC> {
        DB_W::new(self, 4)
    }
    #[doc = "Bit 6 - Number of internal banks"]
    #[inline(always)]
    pub fn inbk(&mut self) -> INBK_W<'_, CTRL2_SPEC> {
        INBK_W::new(self, 6)
    }
    #[doc = "Bits 7:8 - CAS latency"]
    #[inline(always)]
    pub fn cas(&mut self) -> CAS_W<'_, CTRL2_SPEC> {
        CAS_W::new(self, 7)
    }
    #[doc = "Bit 9 - Write protection"]
    #[inline(always)]
    pub fn wrp(&mut self) -> WRP_W<'_, CTRL2_SPEC> {
        WRP_W::new(self, 9)
    }
    #[doc = "Bits 10:11 - Clock division configuration"]
    #[inline(always)]
    pub fn clkdiv(&mut self) -> CLKDIV_W<'_, CTRL2_SPEC> {
        CLKDIV_W::new(self, 10)
    }
    #[doc = "Bit 12 - Burst read"]
    #[inline(always)]
    pub fn bstr(&mut self) -> BSTR_W<'_, CTRL2_SPEC> {
        BSTR_W::new(self, 12)
    }
    #[doc = "Bits 13:14 - Read pipe"]
    #[inline(always)]
    pub fn rd(&mut self) -> RD_W<'_, CTRL2_SPEC> {
        RD_W::new(self, 13)
    }
}
