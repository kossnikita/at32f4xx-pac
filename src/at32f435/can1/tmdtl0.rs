...
pub type R = crate::R<TMDTL0_SPEC>;
#[doc = "Register `TMDTL0` writer"]
pub type W = crate::W<TMDTL0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmdt0(&mut self) -> TMDT0_W<TMDTL0_SPEC, 0> {
        TMDT0_W::new(self)
    }
    #[doc = "Bits 8:15 - Transmit mailbox data byte 1"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt1(&mut self) -> TMDT1_W<TMDTL0_SPEC, 8> {
        TMDT1_W::new(self)
    }
    #[doc = "Bits 16:23 - Transmit mailbox data byte 2"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt2(&mut self) -> TMDT2_W<TMDTL0_SPEC, 16> {
        TMDT2_W::new(self)
    }
    #[doc = "Bits 24:31 - Transmit mailbox data byte 3"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt3(&mut self) -> TMDT3_W<TMDTL0_SPEC, 24> {
        TMDT3_W::new(self)
    }
...
pub struct TMDTL0_SPEC;
impl crate::RegisterSpec for TMDTL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tmdtl0::R`](R) reader structure"]
impl crate::Readable for TMDTL0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`tmdtl0::W`](W) writer structure"]
impl crate::Writable for TMDTL0_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TMDTL0 to value 0"]
impl crate::Resettable for TMDTL0_SPEC {
