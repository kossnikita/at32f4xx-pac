...
impl W {
    #[doc = "Bits 0:7 - Regular memory setup time"]
    #[inline(always)]
    pub fn rgst(&mut self) -> RGST_W<'_, BK4TMGMEM_SPEC> {
        RGST_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Regular memory wait time"]
    #[inline(always)]
    pub fn rgwt(&mut self) -> RGWT_W<'_, BK4TMGMEM_SPEC> {
        RGWT_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Regular memory hold time"]
    #[inline(always)]
    pub fn rght(&mut self) -> RGHT_W<'_, BK4TMGMEM_SPEC> {
        RGHT_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Regular memory databus High resistance time"]
    #[inline(always)]
    pub fn rgdhizt(&mut self) -> RGDHIZT_W<'_, BK4TMGMEM_SPEC> {
