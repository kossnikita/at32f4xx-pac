...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spst(&mut self) -> SPST_W<BK4TMGATT_SPEC, 0> {
        SPST_W::new(self)
    }
    #[doc = "Bits 8:15 - special memory wait time"]
    #[inline(always)]
    #[must_use]
    pub fn spwt(&mut self) -> SPWT_W<BK4TMGATT_SPEC, 8> {
        SPWT_W::new(self)
    }
    #[doc = "Bits 16:23 - special memory hold time"]
    #[inline(always)]
    #[must_use]
    pub fn spht(&mut self) -> SPHT_W<BK4TMGATT_SPEC, 16> {
        SPHT_W::new(self)
    }
    #[doc = "Bits 24:31 - special memory databus High resistance time"]
    #[inline(always)]
    #[must_use]
    pub fn spdhizt(&mut self) -> SPDHIZT_W<BK4TMGATT_SPEC, 24> {
        SPDHIZT_W::new(self)
    }
