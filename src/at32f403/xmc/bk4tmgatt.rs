...
impl W {
    #[doc = "Bits 0:7 - special memory setup time"]
    #[inline(always)]
    pub fn spst(&mut self) -> SPST_W<'_, BK4TMGATT_SPEC> {
        SPST_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - special memory wait time"]
    #[inline(always)]
    pub fn spwt(&mut self) -> SPWT_W<'_, BK4TMGATT_SPEC> {
        SPWT_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - special memory hold time"]
    #[inline(always)]
    pub fn spht(&mut self) -> SPHT_W<'_, BK4TMGATT_SPEC> {
        SPHT_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - special memory databus High resistance time"]
    #[inline(always)]
    pub fn spdhizt(&mut self) -> SPDHIZT_W<'_, BK4TMGATT_SPEC> {
        SPDHIZT_W::new(self, 24)
    }
}
#[doc = "special memory space timing register 4\n\nYou can [`read`](crate::Reg::read) this register and get [`bk4tmgatt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bk4tmgatt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
