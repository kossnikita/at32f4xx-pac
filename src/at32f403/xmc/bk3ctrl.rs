...
impl W {
    #[doc = "Bit 1 - Wait feature enable"]
    #[inline(always)]
    pub fn nwen(&mut self) -> NWEN_W<'_, BK3CTRL_SPEC> {
        NWEN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Memory bank enable"]
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, BK3CTRL_SPEC> {
        EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Memory device type"]
    #[inline(always)]
    pub fn dev(&mut self) -> DEV_W<'_, BK3CTRL_SPEC> {
        DEV_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - External memory data bus width"]
    #[inline(always)]
    pub fn extmdbw(&mut self) -> EXTMDBW_W<'_, BK3CTRL_SPEC> {
        EXTMDBW_W::new(self, 4)
    }
    #[doc = "Bit 6 - ECC enable"]
    #[inline(always)]
    pub fn eccen(&mut self) -> ECCEN_W<'_, BK3CTRL_SPEC> {
        ECCEN_W::new(self, 6)
    }
    #[doc = "Bits 9:12 - CLE to RE delay"]
    #[inline(always)]
    pub fn tcr(&mut self) -> TCR_W<'_, BK3CTRL_SPEC> {
        TCR_W::new(self, 9)
    }
    #[doc = "Bits 13:16 - ALE to RE delay"]
    #[inline(always)]
    pub fn tar(&mut self) -> TAR_W<'_, BK3CTRL_SPEC> {
        TAR_W::new(self, 13)
    }
    #[doc = "Bits 17:19 - ECC page size"]
    #[inline(always)]
    pub fn eccpgs(&mut self) -> ECCPGS_W<'_, BK3CTRL_SPEC> {
        ECCPGS_W::new(self, 17)
    }
}
#[doc = "PC Card/NAND Flash control register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`bk3ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bk3ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
