...
impl W {
    #[doc = "Bit 0 - Memory bank enable"]
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, BK1CTRL2_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Address and data multiplexing enable"]
    #[inline(always)]
    pub fn admuxen(&mut self) -> ADMUXEN_W<'_, BK1CTRL2_SPEC> {
        ADMUXEN_W::new(self, 1)
    }
    #[doc = "Bits 2:3 - Memory device type"]
    #[inline(always)]
    pub fn dev(&mut self) -> DEV_W<'_, BK1CTRL2_SPEC> {
        DEV_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - External memory data bus width"]
    #[inline(always)]
    pub fn extmdbw(&mut self) -> EXTMDBW_W<'_, BK1CTRL2_SPEC> {
        EXTMDBW_W::new(self, 4)
    }
    #[doc = "Bit 6 - Nor flash access enable"]
    #[inline(always)]
    pub fn noren(&mut self) -> NOREN_W<'_, BK1CTRL2_SPEC> {
        NOREN_W::new(self, 6)
    }
    #[doc = "Bit 8 - Synchronous burst enable"]
    #[inline(always)]
    pub fn syncben(&mut self) -> SYNCBEN_W<'_, BK1CTRL2_SPEC> {
        SYNCBEN_W::new(self, 8)
    }
    #[doc = "Bit 9 - NWAIT polarity"]
    #[inline(always)]
    pub fn nwpol(&mut self) -> NWPOL_W<'_, BK1CTRL2_SPEC> {
        NWPOL_W::new(self, 9)
    }
    #[doc = "Bit 10 - Wrapped enable"]
    #[inline(always)]
    pub fn wrapen(&mut self) -> WRAPEN_W<'_, BK1CTRL2_SPEC> {
        WRAPEN_W::new(self, 10)
    }
    #[doc = "Bit 11 - Wait timing configuration"]
    #[inline(always)]
    pub fn nwtcfg(&mut self) -> NWTCFG_W<'_, BK1CTRL2_SPEC> {
        NWTCFG_W::new(self, 11)
    }
    #[doc = "Bit 12 - Write enable"]
    #[inline(always)]
    pub fn wen(&mut self) -> WEN_W<'_, BK1CTRL2_SPEC> {
        WEN_W::new(self, 12)
    }
    #[doc = "Bit 13 - NWAIT in synchronous transfer enable"]
    #[inline(always)]
    pub fn nwsen(&mut self) -> NWSEN_W<'_, BK1CTRL2_SPEC> {
        NWSEN_W::new(self, 13)
    }
    #[doc = "Bit 14 - Read-write timing different"]
    #[inline(always)]
    pub fn rwtd(&mut self) -> RWTD_W<'_, BK1CTRL2_SPEC> {
        RWTD_W::new(self, 14)
    }
    #[doc = "Bit 15 - NWAIT in asynchronous transfer enable"]
    #[inline(always)]
    pub fn nwasen(&mut self) -> NWASEN_W<'_, BK1CTRL2_SPEC> {
        NWASEN_W::new(self, 15)
    }
    #[doc = "Bits 16:18 - CRAM page size"]
    #[inline(always)]
    pub fn crpgs(&mut self) -> CRPGS_W<'_, BK1CTRL2_SPEC> {
        CRPGS_W::new(self, 16)
    }
    #[doc = "Bit 19 - Memory write mode control"]
    #[inline(always)]
    pub fn mwmc(&mut self) -> MWMC_W<'_, BK1CTRL2_SPEC> {
        MWMC_W::new(self, 19)
    }
}
