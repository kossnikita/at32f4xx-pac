...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<BK1CTRL2_SPEC, 0> {
        EN_W::new(self)
    }
    #[doc = "Bit 1 - Address and data multiplexing enable"]
    #[inline(always)]
    #[must_use]
    pub fn admuxen(&mut self) -> ADMUXEN_W<BK1CTRL2_SPEC, 1> {
        ADMUXEN_W::new(self)
    }
    #[doc = "Bits 2:3 - Memory device type"]
    #[inline(always)]
    #[must_use]
    pub fn dev(&mut self) -> DEV_W<BK1CTRL2_SPEC, 2> {
        DEV_W::new(self)
    }
    #[doc = "Bits 4:5 - External memory data bus width"]
    #[inline(always)]
    #[must_use]
    pub fn extmdbw(&mut self) -> EXTMDBW_W<BK1CTRL2_SPEC, 4> {
        EXTMDBW_W::new(self)
    }
    #[doc = "Bit 6 - Nor flash access enable"]
    #[inline(always)]
    #[must_use]
    pub fn noren(&mut self) -> NOREN_W<BK1CTRL2_SPEC, 6> {
        NOREN_W::new(self)
    }
    #[doc = "Bit 8 - Synchronous burst enable"]
    #[inline(always)]
    #[must_use]
    pub fn syncben(&mut self) -> SYNCBEN_W<BK1CTRL2_SPEC, 8> {
        SYNCBEN_W::new(self)
    }
    #[doc = "Bit 9 - NWAIT polarity"]
    #[inline(always)]
    #[must_use]
    pub fn nwpol(&mut self) -> NWPOL_W<BK1CTRL2_SPEC, 9> {
        NWPOL_W::new(self)
    }
    #[doc = "Bit 10 - Wrapped enable"]
    #[inline(always)]
    #[must_use]
    pub fn wrapen(&mut self) -> WRAPEN_W<BK1CTRL2_SPEC, 10> {
        WRAPEN_W::new(self)
    }
    #[doc = "Bit 11 - Wait timing configuration"]
    #[inline(always)]
    #[must_use]
    pub fn nwtcfg(&mut self) -> NWTCFG_W<BK1CTRL2_SPEC, 11> {
        NWTCFG_W::new(self)
    }
    #[doc = "Bit 12 - Write enable"]
    #[inline(always)]
    #[must_use]
    pub fn wen(&mut self) -> WEN_W<BK1CTRL2_SPEC, 12> {
        WEN_W::new(self)
    }
    #[doc = "Bit 13 - NWAIT in synchronous transfer enable"]
    #[inline(always)]
    #[must_use]
    pub fn nwsen(&mut self) -> NWSEN_W<BK1CTRL2_SPEC, 13> {
        NWSEN_W::new(self)
    }
    #[doc = "Bit 14 - Read-write timing different"]
    #[inline(always)]
    #[must_use]
    pub fn rwtd(&mut self) -> RWTD_W<BK1CTRL2_SPEC, 14> {
        RWTD_W::new(self)
    }
    #[doc = "Bit 15 - NWAIT in asynchronous transfer enable"]
    #[inline(always)]
    #[must_use]
    pub fn nwasen(&mut self) -> NWASEN_W<BK1CTRL2_SPEC, 15> {
        NWASEN_W::new(self)
    }
    #[doc = "Bits 16:18 - CRAM page size"]
    #[inline(always)]
    #[must_use]
    pub fn crpgs(&mut self) -> CRPGS_W<BK1CTRL2_SPEC, 16> {
        CRPGS_W::new(self)
    }
    #[doc = "Bit 19 - Memory write mode control"]
    #[inline(always)]
    #[must_use]
    pub fn mwmc(&mut self) -> MWMC_W<BK1CTRL2_SPEC, 19> {
        MWMC_W::new(self)
    }
