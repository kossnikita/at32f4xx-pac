...
impl core::fmt::Debug for crate::generic::Reg<BK3TMGATT_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn spst(&mut self) -> SPST_W<BK3TMGATT_SPEC, 0> {
        SPST_W::new(self)
    }
    #[doc = "Bits 8:15 - special memory wait time"]
    #[inline(always)]
    #[must_use]
    pub fn spwt(&mut self) -> SPWT_W<BK3TMGATT_SPEC, 8> {
        SPWT_W::new(self)
    }
    #[doc = "Bits 16:23 - special memory hold time"]
    #[inline(always)]
    #[must_use]
    pub fn spht(&mut self) -> SPHT_W<BK3TMGATT_SPEC, 16> {
        SPHT_W::new(self)
    }
    #[doc = "Bits 24:31 - special memory databus High resistance time"]
    #[inline(always)]
    #[must_use]
    pub fn spdhizt(&mut self) -> SPDHIZT_W<BK3TMGATT_SPEC, 24> {
        SPDHIZT_W::new(self)
    }
...
#[doc = "special memory space timing register 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bk3tmgatt::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bk3tmgatt::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
