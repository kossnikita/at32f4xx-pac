...
impl W {
    #[doc = "Bits 0:7 - IO space setup time"]
    #[inline(always)]
    pub fn iost(&mut self) -> IOST_W<'_, BK4TMGIO_SPEC> {
        IOST_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - IO space wait time"]
    #[inline(always)]
    pub fn iowt(&mut self) -> IOWT_W<'_, BK4TMGIO_SPEC> {
        IOWT_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - IO space hold time"]
    #[inline(always)]
    pub fn ioht(&mut self) -> IOHT_W<'_, BK4TMGIO_SPEC> {
        IOHT_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - IO space databus High resistance time"]
    #[inline(always)]
    pub fn iodhizt(&mut self) -> IODHIZT_W<'_, BK4TMGIO_SPEC> {
