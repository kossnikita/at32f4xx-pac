...
pub type COCTRL_R = crate::FieldReader<C1OCTRL_A>;
...
impl From<C1OCTRL_A> for u8 {
    #[inline(always)]
    fn from(variant: C1OCTRL_A) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for C1OCTRL_A {
    type Ux = u8;
}
impl COCTRL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> C1OCTRL_A {
        match self.bits {
            0 => C1OCTRL_A::Disconnected,
            1 => C1OCTRL_A::High,
            2 => C1OCTRL_A::Low,
            3 => C1OCTRL_A::Toggle,
            4 => C1OCTRL_A::ForceLow,
            5 => C1OCTRL_A::ForceHigh,
            6 => C1OCTRL_A::PwmA,
            7 => C1OCTRL_A::PwmB,
            _ => unreachable!(),
        }
...
pub type COCTRL_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 3, O, C1OCTRL_A>;
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn disconnected(self) -> &'a mut crate::W<REG> {
        self.variant(C1OCTRL_A::Disconnected)
    }
    #[doc = "CxORAW is high when TMRx_CVAL=TMRx_CxDT"]
    #[inline(always)]
    pub fn high(self) -> &'a mut crate::W<REG> {
        self.variant(C1OCTRL_A::High)
    }
    #[doc = "CxORAW is low when TMRx_CVAL=TMRx_CxDT"]
    #[inline(always)]
    pub fn low(self) -> &'a mut crate::W<REG> {
        self.variant(C1OCTRL_A::Low)
    }
    #[doc = "Switch CxORAW level when TMRx_CVAL=TMRx_CxDT"]
    #[inline(always)]
    pub fn toggle(self) -> &'a mut crate::W<REG> {
        self.variant(C1OCTRL_A::Toggle)
    }
    #[doc = "CxORAW is forced low"]
    #[inline(always)]
    pub fn force_low(self) -> &'a mut crate::W<REG> {
        self.variant(C1OCTRL_A::ForceLow)
    }
    #[doc = "CxORAW is forced high"]
    #[inline(always)]
    pub fn force_high(self) -> &'a mut crate::W<REG> {
        self.variant(C1OCTRL_A::ForceHigh)
    }
    #[doc = "PWM mode A"]
    #[inline(always)]
    pub fn pwm_a(self) -> &'a mut crate::W<REG> {
        self.variant(C1OCTRL_A::PwmA)
    }
    #[doc = "PWM mode B"]
    #[inline(always)]
    pub fn pwm_b(self) -> &'a mut crate::W<REG> {
        self.variant(C1OCTRL_A::PwmB)
    }
}
