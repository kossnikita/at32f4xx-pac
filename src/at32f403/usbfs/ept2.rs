...
pub type R = crate::R<EPT2_SPEC>;
#[doc = "Register `EPT2` writer"]
pub type W = crate::W<EPT2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eptaddr(&mut self) -> EPTADDR_W<EPT2_SPEC, 0> {
        EPTADDR_W::new(self)
    }
    #[doc = "Bits 4:5 - Tx status"]
    #[inline(always)]
    #[must_use]
    pub fn txsts(&mut self) -> TXSTS_W<EPT2_SPEC, 4> {
        TXSTS_W::new(self)
    }
    #[doc = "Bit 6 - Tx data toggle synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn txdts(&mut self) -> TXDTS_W<EPT2_SPEC, 6> {
        TXDTS_W::new(self)
    }
    #[doc = "Bit 7 - Tx transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn txtc(&mut self) -> TXTC_W<EPT2_SPEC, 7> {
        TXTC_W::new(self)
    }
    #[doc = "Bit 8 - Endpoint extend function"]
    #[inline(always)]
    #[must_use]
    pub fn exf(&mut self) -> EXF_W<EPT2_SPEC, 8> {
        EXF_W::new(self)
    }
    #[doc = "Bits 9:10 - Transfer type"]
    #[inline(always)]
    #[must_use]
    pub fn trans_type(&mut self) -> TRANS_TYPE_W<EPT2_SPEC, 9> {
        TRANS_TYPE_W::new(self)
    }
    #[doc = "Bit 11 - Setup transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn setuptc(&mut self) -> SETUPTC_W<EPT2_SPEC, 11> {
        SETUPTC_W::new(self)
    }
    #[doc = "Bits 12:13 - Rx Status"]
    #[inline(always)]
    #[must_use]
    pub fn rxsts(&mut self) -> RXSTS_W<EPT2_SPEC, 12> {
        RXSTS_W::new(self)
    }
    #[doc = "Bit 14 - Rx data toggle synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn rxdts(&mut self) -> RXDTS_W<EPT2_SPEC, 14> {
        RXDTS_W::new(self)
    }
    #[doc = "Bit 15 - Rx transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn rxtc(&mut self) -> RXTC_W<EPT2_SPEC, 15> {
        RXTC_W::new(self)
    }
...
pub struct EPT2_SPEC;
impl crate::RegisterSpec for EPT2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ept2::R`](R) reader structure"]
impl crate::Readable for EPT2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ept2::W`](W) writer structure"]
impl crate::Writable for EPT2_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets EPT2 to value 0"]
impl crate::Resettable for EPT2_SPEC {
