...
pub type R = crate::R<C2MADDR_SPEC>;
#[doc = "Register `C2MADDR` writer"]
pub type W = crate::W<C2MADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn maddr(&mut self) -> MADDR_W<C2MADDR_SPEC, 0> {
        MADDR_W::new(self)
    }
...
pub struct C2MADDR_SPEC;
impl crate::RegisterSpec for C2MADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c2maddr::R`](R) reader structure"]
impl crate::Readable for C2MADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`c2maddr::W`](W) writer structure"]
impl crate::Writable for C2MADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C2MADDR to value 0"]
impl crate::Resettable for C2MADDR_SPEC {
