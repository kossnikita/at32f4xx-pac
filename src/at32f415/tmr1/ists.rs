...
pub type TRGIF_W<'a, REG> = crate::BitWriter0C<'a, REG, TRGIFW_AW>;
...
interrupt flag"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn c3if(&mut self) -> CIF_W<ISTS_SPEC> {
        CIF_W::new(self, 3)
    }
    #[doc = "Bit 4 - Channel 4 interrupt flag"]
    #[inline(always)]
...
recapture flag"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn c3rf(&mut self) -> CRF_W<ISTS_SPEC> {
        CRF_W::new(self, 11)
    }
    #[doc = "Bit 12 - Channel 4 recapture flag"]
    #[inline(always)]
    #[must_use]
    pub fn c4rf(&mut self) -> CRF_W<ISTS_SPEC> {
        CRF_W::new(self, 12)
    }
