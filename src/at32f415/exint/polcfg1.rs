...
pub type RP19_R = crate::BitReader;
#[doc = "Field `RP19` writer - Rising polarity configuration bit of line 19"]
pub type RP19_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `RP20` reader - Rising polarity configuration bit of line 20"]
pub type RP20_R = crate::BitReader;
#[doc = "Field `RP20` writer - Rising polarity configuration bit of line 20"]
pub type RP20_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl R {
    ...
    #[doc = "Bit 20 - Rising polarity configuration bit of line 20"]
    #[inline(always)]
    pub fn rp20(&self) -> RP20_R {
        RP20_R::new(((self.bits >> 20) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rp19(&mut self) -> RP19_W<POLCFG1_SPEC, 19> {
        RP19_W::new(self)
    }
    #[doc = "Bit 20 - Rising polarity configuration bit of line 20"]
    #[inline(always)]
    #[must_use]
    pub fn rp20(&mut self) -> RP20_W<POLCFG1_SPEC, 20> {
        RP20_W::new(self)
    }
    #[doc = "Bit 21 - Rising polarity configuration bit of line 21"]
    #[inline(always)]
