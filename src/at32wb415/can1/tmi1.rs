...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmsr(&mut self) -> TMSR_W<TMI1_SPEC, 0> {
        TMSR_W::new(self)
    }
    #[doc = "Bit 1 - Transmit mailbox frame type select"]
    #[inline(always)]
    #[must_use]
    pub fn tmfrsel(&mut self) -> TMFRSEL_W<TMI1_SPEC, 1> {
        TMFRSEL_W::new(self)
    }
    #[doc = "Bit 2 - Transmit mailbox identifier type select"]
    #[inline(always)]
    #[must_use]
    pub fn tmidsel(&mut self) -> TMIDSEL_W<TMI1_SPEC, 2> {
        TMIDSEL_W::new(self)
    }
    #[doc = "Bits 3:20 - Ttransmit mailbox extended identifier"]
    #[inline(always)]
    #[must_use]
    pub fn tmeid(&mut self) -> TMEID_W<TMI1_SPEC, 3> {
        TMEID_W::new(self)
    }
    #[doc = "Bits 21:31 - Transmit mailbox standard identifier or extended identifier high bytes"]
    #[inline(always)]
    #[must_use]
    pub fn tmsid(&mut self) -> TMSID_W<TMI1_SPEC, 21> {
        TMSID_W::new(self)
    }
