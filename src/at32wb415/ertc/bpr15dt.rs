...
pub type R = crate::R<BPR15DT_SPEC>;
#[doc = "Register `BPR15DT` writer"]
pub type W = crate::W<BPR15DT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DT_W<BPR15DT_SPEC, 0> {
        DT_W::new(self)
    }
...
pub struct BPR15DT_SPEC;
impl crate::RegisterSpec for BPR15DT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bpr15dt::R`](R) reader structure"]
impl crate::Readable for BPR15DT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`bpr15dt::W`](W) writer structure"]
impl crate::Writable for BPR15DT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets BPR15DT to value 0"]
impl crate::Resettable for BPR15DT_SPEC {
