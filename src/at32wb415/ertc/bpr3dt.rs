...
pub type R = crate::R<BPR3DT_SPEC>;
#[doc = "Register `BPR3DT` writer"]
pub type W = crate::W<BPR3DT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DT_W<BPR3DT_SPEC, 0> {
        DT_W::new(self)
    }
...
pub struct BPR3DT_SPEC;
impl crate::RegisterSpec for BPR3DT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bpr3dt::R`](R) reader structure"]
impl crate::Readable for BPR3DT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`bpr3dt::W`](W) writer structure"]
impl crate::Writable for BPR3DT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets BPR3DT to value 0"]
impl crate::Resettable for BPR3DT_SPEC {
