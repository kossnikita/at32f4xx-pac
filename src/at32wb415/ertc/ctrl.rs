...
pub type ALBEN_R = crate::BitReader;
#[doc = "Field `ALBEN` writer - Alarm B enable"]
pub type ALBEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ALBIEN_R = crate::BitReader;
#[doc = "Field `ALBIEN` writer - Alarm B interrupt enable"]
pub type ALBIEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
