...
pub mod misc1;
#[doc = "OTG_EXTCTRL (rw) register accessor: OTGFS external ctrl register1\n\nYou can [`read`](crate::Reg::read) this register and get [`otg_extctrl::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otg_extctrl::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otg_extctrl`] module"]
