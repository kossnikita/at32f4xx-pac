...
pub type R = crate::R<C3CTRL_SPEC>;
#[doc = "Register `C3CTRL` writer"]
pub type W = crate::W<C3CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chen(&mut self) -> CHEN_W<C3CTRL_SPEC, 0> {
        CHEN_W::new(self)
    }
    #[doc = "Bit 1 - Full data transfer interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fdtien(&mut self) -> FDTIEN_W<C3CTRL_SPEC, 1> {
        FDTIEN_W::new(self)
    }
    #[doc = "Bit 2 - Half data transfer interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn hdtien(&mut self) -> HDTIEN_W<C3CTRL_SPEC, 2> {
        HDTIEN_W::new(self)
    }
    #[doc = "Bit 3 - Data transfer error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dterrien(&mut self) -> DTERRIEN_W<C3CTRL_SPEC, 3> {
        DTERRIEN_W::new(self)
    }
    #[doc = "Bit 4 - Data transfer direction"]
    #[inline(always)]
    #[must_use]
    pub fn dtd(&mut self) -> DTD_W<C3CTRL_SPEC, 4> {
        DTD_W::new(self)
    }
    #[doc = "Bit 5 - Loop mode"]
    #[inline(always)]
    #[must_use]
    pub fn lm(&mut self) -> LM_W<C3CTRL_SPEC, 5> {
        LM_W::new(self)
    }
    #[doc = "Bit 6 - Peripheral address increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn pincm(&mut self) -> PINCM_W<C3CTRL_SPEC, 6> {
        PINCM_W::new(self)
    }
    #[doc = "Bit 7 - Memory address increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn mincm(&mut self) -> MINCM_W<C3CTRL_SPEC, 7> {
        MINCM_W::new(self)
    }
    #[doc = "Bits 8:9 - Peripheral data bit width"]
    #[inline(always)]
    #[must_use]
    pub fn pwidth(&mut self) -> PWIDTH_W<C3CTRL_SPEC, 8> {
        PWIDTH_W::new(self)
    }
    #[doc = "Bits 10:11 - Memory data bit width"]
    #[inline(always)]
    #[must_use]
    pub fn mwidth(&mut self) -> MWIDTH_W<C3CTRL_SPEC, 10> {
        MWIDTH_W::new(self)
    }
    #[doc = "Bits 12:13 - Channel Priority level"]
    #[inline(always)]
    #[must_use]
    pub fn chpl(&mut self) -> CHPL_W<C3CTRL_SPEC, 12> {
        CHPL_W::new(self)
    }
    #[doc = "Bit 14 - Memory to memory mode"]
    #[inline(always)]
    #[must_use]
    pub fn m2m(&mut self) -> M2M_W<C3CTRL_SPEC, 14> {
        M2M_W::new(self)
    }
...
pub struct C3CTRL_SPEC;
impl crate::RegisterSpec for C3CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c3ctrl::R`](R) reader structure"]
impl crate::Readable for C3CTRL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`c3ctrl::W`](W) writer structure"]
impl crate::Writable for C3CTRL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C3CTRL to value 0"]
impl crate::Resettable for C3CTRL_SPEC {
