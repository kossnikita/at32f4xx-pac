...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfercmsk(&mut self) -> XFERCMSK_W<DOEPEACHMSK1_SPEC> {
        XFERCMSK_W::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn eptdismsk(&mut self) -> EPTDISMSK_W<DOEPEACHMSK1_SPEC> {
        EPTDISMSK_W::new(self, 1)
    }
    #[doc = "Bit 2 - AHB Error mask"]
    #[inline(always)]
    #[must_use]
    pub fn ahberrmsk(&mut self) -> AHBERRMSK_W<DOEPEACHMSK1_SPEC> {
        AHBERRMSK_W::new(self, 2)
    }
    #[doc = "Bit 3 - SETUP phase done mask"]
    #[inline(always)]
    #[must_use]
    pub fn setupmsk(&mut self) -> SETUPMSK_W<DOEPEACHMSK1_SPEC> {
        SETUPMSK_W::new(self, 3)
    }
    #[doc = "Bit 4 - OUT token received when endpoint disabled mask"]
    #[inline(always)]
    #[must_use]
    pub fn outtepdmsk(&mut self) -> OUTTEPDMSK_W<DOEPEACHMSK1_SPEC> {
        OUTTEPDMSK_W::new(self, 4)
    }
    #[doc = "Bit 5 - Status Phase Received mask"]
    #[inline(always)]
    #[must_use]
    pub fn stsphsercvdmsk(&mut self) -> STSPHSERCVDMSK_W<DOEPEACHMSK1_SPEC> {
        STSPHSERCVDMSK_W::new(self, 5)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets received mask"]
    #[inline(always)]
    #[must_use]
    pub fn b2bsetupmsk(&mut self) -> B2BSETUPMSK_W<DOEPEACHMSK1_SPEC> {
        B2BSETUPMSK_W::new(self, 6)
    }
    #[doc = "Bit 8 - OUT packet error mask"]
    #[inline(always)]
    #[must_use]
    pub fn outperrmsk(&mut self) -> OUTPERRMSK_W<DOEPEACHMSK1_SPEC> {
        OUTPERRMSK_W::new(self, 8)
    }
    #[doc = "Bit 9 - BNA interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn bnaoutmsk(&mut self) -> BNAOUTMSK_W<DOEPEACHMSK1_SPEC> {
        BNAOUTMSK_W::new(self, 9)
    }
    #[doc = "Bit 12 - Babble Error interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn bbleerrmsk(&mut self) -> BBLEERRMSK_W<DOEPEACHMSK1_SPEC> {
        BBLEERRMSK_W::new(self, 12)
    }
    #[doc = "Bit 13 - NAK interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn nakmsk(&mut self) -> NAKMSK_W<DOEPEACHMSK1_SPEC> {
        NAKMSK_W::new(self, 13)
    }
    #[doc = "Bit 14 - NYET interrupt mask"]
    #[inline(always)]
    #[must_use]
    pub fn nyetmsk(&mut self) -> NYETMSK_W<DOEPEACHMSK1_SPEC> {
