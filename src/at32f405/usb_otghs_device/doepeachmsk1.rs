...
impl W {
    #[doc = "Bit 0 - Transfer completed interrupt mask"]
    #[inline(always)]
    pub fn xfercmsk(&mut self) -> XFERCMSK_W<'_, DOEPEACHMSK1_SPEC> {
        XFERCMSK_W::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt mask"]
    #[inline(always)]
    pub fn eptdismsk(&mut self) -> EPTDISMSK_W<'_, DOEPEACHMSK1_SPEC> {
    ...
    #[doc = "Bit 4 - OUT token received when endpoint disabled mask"]
    #[inline(always)]
    pub fn outtepdmsk(&mut self) -> OUTTEPDMSK_W<'_, DOEPEACHMSK1_SPEC> {
        OUTTEPDMSK_W::new(self, 4)
    }
    #[doc = "Bit 5 - Status Phase Received mask"]
    #[inline(always)]
    pub fn stsphsercvdmsk(&mut self) -> STSPHSERCVDMSK_W<'_, DOEPEACHMSK1_SPEC> {
        STSPHSERCVDMSK_W::new(self, 5)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets received mask"]
    #[inline(always)]
    pub fn b2bsetupmsk(&mut self) -> B2BSETUPMSK_W<'_, DOEPEACHMSK1_SPEC> {
        B2BSETUPMSK_W::new(self, 6)
    }
    #[doc = "Bit 8 - OUT packet error mask"]
    #[inline(always)]
    pub fn outperrmsk(&mut self) -> OUTPERRMSK_W<'_, DOEPEACHMSK1_SPEC> {
        OUTPERRMSK_W::new(self, 8)
    }
    #[doc = "Bit 9 - BNA interrupt mask"]
    #[inline(always)]
    pub fn bnaoutmsk(&mut self) -> BNAOUTMSK_W<'_, DOEPEACHMSK1_SPEC> {
