...
pub type R = crate::R<HCDMA9_SPEC>;
#[doc = "Register `HCDMA9` writer"]
pub type W = crate::W<HCDMA9_SPEC>;
...
impl core::fmt::Debug for crate::generic::Reg<HCDMA9_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<HCDMA9_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
#[doc = "Host channel 9 DMA address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hcdma9::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hcdma9::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
