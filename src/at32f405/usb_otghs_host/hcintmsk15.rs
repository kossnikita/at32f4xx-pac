...
impl core::fmt::Debug for crate::generic::Reg<HCINTMSK15_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahberrmsk(&mut self) -> AHBERRMSK_W<HCINTMSK15_SPEC, 2> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nyetmsk(&mut self) -> NYETMSK_W<HCINTMSK15_SPEC, 6> {
        NYETMSK_W::new(self)
    }
    #[doc = "Bit 7 - Transaction error mask"]
    #[inline(always)]
