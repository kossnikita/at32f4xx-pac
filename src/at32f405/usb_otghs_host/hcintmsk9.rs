...
impl W {
    #[doc = "Bit 0 - Transfer completed mask"]
    #[inline(always)]
    pub fn xfercmsk(&mut self) -> XFERCMSK_W<'_, HCINTMSK9_SPEC> {
    ...
    #[doc = "Bit 3 - STALL response received interrupt mask"]
    #[inline(always)]
    pub fn stallmsk(&mut self) -> STALLMSK_W<'_, HCINTMSK9_SPEC> {
        STALLMSK_W::new(self, 3)
    }
    #[doc = "Bit 4 - NAK response received interrupt mask"]
    #[inline(always)]
    pub fn nakmsk(&mut self) -> NAKMSK_W<'_, HCINTMSK9_SPEC> {
        NAKMSK_W::new(self, 4)
    }
    #[doc = "Bit 5 - ACK response received/transmitted interrupt mask"]
    #[inline(always)]
    pub fn ackmsk(&mut self) -> ACKMSK_W<'_, HCINTMSK9_SPEC> {
        ACKMSK_W::new(self, 5)
    }
    #[doc = "Bit 6 - NYET Response Received interrupt mask"]
    #[inline(always)]
    pub fn nyetmsk(&mut self) -> NYETMSK_W<'_, HCINTMSK9_SPEC> {
        NYETMSK_W::new(self, 6)
    }
    #[doc = "Bit 7 - Transaction error mask"]
    #[inline(always)]
    pub fn xacterrmsk(&mut self) -> XACTERRMSK_W<'_, HCINTMSK9_SPEC> {
        XACTERRMSK_W::new(self, 7)
    }
    #[doc = "Bit 8 - Babble error mask"]
    #[inline(always)]
    pub fn bblerrmsk(&mut self) -> BBLERRMSK_W<'_, HCINTMSK9_SPEC> {
        BBLERRMSK_W::new(self, 8)
    }
    #[doc = "Bit 9 - Frame overrun mask"]
    #[inline(always)]
    pub fn frmovrunmsk(&mut self) -> FRMOVRUNMSK_W<'_, HCINTMSK9_SPEC> {
        FRMOVRUNMSK_W::new(self, 9)
    }
    #[doc = "Bit 10 - Data toggle error mask"]
    #[inline(always)]
    pub fn dtglerrmsk(&mut self) -> DTGLERRMSK_W<'_, HCINTMSK9_SPEC> {
