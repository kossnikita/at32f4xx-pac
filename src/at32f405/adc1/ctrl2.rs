...
pub type PCTESEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
pub type OCTESEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pctesel(&mut self) -> PCTESEL_W<CTRL2_SPEC, 12> {
        PCTESEL_W::new(self)
    }
    #[doc = "Bit 15 - Trigger mode enable for preempted channels conversion"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn octesel(&mut self) -> OCTESEL_W<CTRL2_SPEC, 17> {
        OCTESEL_W::new(self)
    }
    #[doc = "Bit 20 - Trigger mode enable for ordinary channels conversion"]
    #[inline(always)]
