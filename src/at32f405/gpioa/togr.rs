...
impl W {
    ...
    #[inline(always)]
    pub fn iotb0(&mut self) -> IOTB0_W<'_, TOGR_SPEC> {
        IOTB0_W::new(self, 0)
    }
    #[doc = "Bit 1 - toggle bit 1"]
    #[inline(always)]
    pub fn iotb1(&mut self) -> IOTB1_W<'_, TOGR_SPEC> {
        IOTB1_W::new(self, 1)
    }
    #[doc = "Bit 2 - toggle bit 2"]
    #[inline(always)]
    pub fn iotb2(&mut self) -> IOTB2_W<'_, TOGR_SPEC> {
        IOTB2_W::new(self, 2)
    }
    #[doc = "Bit 3 - toggle bit 3"]
    #[inline(always)]
    pub fn iotb3(&mut self) -> IOTB3_W<'_, TOGR_SPEC> {
        IOTB3_W::new(self, 3)
    }
    #[doc = "Bit 4 - toggle bit 4"]
    #[inline(always)]
    pub fn iotb4(&mut self) -> IOTB4_W<'_, TOGR_SPEC> {
        IOTB4_W::new(self, 4)
    }
    #[doc = "Bit 5 - toggle bit 5"]
    #[inline(always)]
    pub fn iotb5(&mut self) -> IOTB5_W<'_, TOGR_SPEC> {
        IOTB5_W::new(self, 5)
    }
    #[doc = "Bit 6 - toggle bit 6"]
    #[inline(always)]
    pub fn iotb6(&mut self) -> IOTB6_W<'_, TOGR_SPEC> {
        IOTB6_W::new(self, 6)
    }
    #[doc = "Bit 7 - toggle bit 7"]
    #[inline(always)]
    pub fn iotb7(&mut self) -> IOTB7_W<'_, TOGR_SPEC> {
        IOTB7_W::new(self, 7)
    }
    #[doc = "Bit 8 - toggle bit 8"]
    #[inline(always)]
    pub fn iotb8(&mut self) -> IOTB8_W<'_, TOGR_SPEC> {
        IOTB8_W::new(self, 8)
    }
    #[doc = "Bit 9 - toggle bit 9"]
    #[inline(always)]
    pub fn iotb9(&mut self) -> IOTB9_W<'_, TOGR_SPEC> {
        IOTB9_W::new(self, 9)
    }
    #[doc = "Bit 10 - toggle bit 10"]
    #[inline(always)]
    pub fn iotb10(&mut self) -> IOTB10_W<'_, TOGR_SPEC> {
        IOTB10_W::new(self, 10)
    }
    #[doc = "Bit 11 - toggle bit 11"]
    #[inline(always)]
    pub fn iotb11(&mut self) -> IOTB11_W<'_, TOGR_SPEC> {
        IOTB11_W::new(self, 11)
    }
    #[doc = "Bit 12 - toggle bit 12"]
    #[inline(always)]
    pub fn iotb12(&mut self) -> IOTB12_W<'_, TOGR_SPEC> {
        IOTB12_W::new(self, 12)
    }
    #[doc = "Bit 13 - toggle bit 13"]
    #[inline(always)]
    pub fn iotb13(&mut self) -> IOTB13_W<'_, TOGR_SPEC> {
        IOTB13_W::new(self, 13)
    }
    #[doc = "Bit 14 - toggle bit 14"]
    #[inline(always)]
    pub fn iotb14(&mut self) -> IOTB14_W<'_, TOGR_SPEC> {
        IOTB14_W::new(self, 14)
    }
    #[doc = "Bit 15 - toggle bit 15"]
    #[inline(always)]
    pub fn iotb15(&mut self) -> IOTB15_W<'_, TOGR_SPEC> {
