...
pub type PLLU_USB48_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllu_usb48_sel(&mut self) -> PLLU_USB48_SEL_W<MISC2_SPEC, 10> {
        PLLU_USB48_SEL_W::new(self)
    }
    #[doc = "Bits 16:18 - HICK as system clock frequency division"]
    #[inline(always)]
    #[must_use]
