...
#[doc = "Field `I2S5RST` reader - I2S5 reset"]
pub type I2S5RST_R = crate::BitReader;
#[doc = "Field `I2S5RST` writer - I2S5 reset"]
pub type I2S5RST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `OTGHSPHYRST` reader - OTGHS phy reset"]
pub type OTGHSPHYRST_R = crate::BitReader;
#[doc = "Field `OTGHSPHYRST` writer - OTGHS phy reset"]
pub type OTGHSPHYRST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    ...
    #[inline(always)]
    pub fn i2s5rst(&self) -> I2S5RST_R {
        I2S5RST_R::new(((self.bits >> 20) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn otghsphyrst(&self) -> OTGHSPHYRST_R {
        OTGHSPHYRST_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Timer1 reset"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2s5rst(&mut self) -> I2S5RST_W<APB2RST_SPEC, 20> {
        I2S5RST_W::new(self)
    }
    #[doc = "Bit 29 - ACC reset"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn otghsphyrst(&mut self) -> OTGHSPHYRST_W<APB2RST_SPEC, 31> {
        OTGHSPHYRST_W::new(self)
    }
