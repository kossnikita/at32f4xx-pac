...
#[doc = "Field `OTGHSRST` reader - OTGHS interface reset"]
pub type OTGHSRST_R = crate::BitReader;
#[doc = "Field `OTGHSRST` writer - OTGHS interface reset"]
pub type OTGHSRST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn otghsrst(&mut self) -> OTGHSRST_W<AHBRST1_SPEC, 29> {
        OTGHSRST_W::new(self)
    }
