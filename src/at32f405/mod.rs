#![doc = "Peripheral access API for AT32F405 microcontrollers (generated using svd2rust v0.33.4 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            USB_OTGHS_GLOBAL: USB_OTGHS_GLOBAL::steal(),
            USB_OTGHS_HOST: USB_OTGHS_HOST::steal(),
            USB_OTGHS_DEVICE: USB_OTGHS_DEVICE::steal(),
            USB_OTGHS_PWRCLK: USB_OTGHS_PWRCLK::steal(),
            SCFG: SCFG::steal(),
            QSPI1: QSPI1::steal(),
        }
    }
