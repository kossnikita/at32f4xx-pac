...
pub mod exintc4;
#[doc = "UHDRV (rw) register accessor: Ultra high drive register\n\nYou can [`read`](crate::Reg::read) this register and get [`uhdrv::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`uhdrv::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@uhdrv`] module"]
pub type UHDRV = crate::Reg<uhdrv::UHDRV_SPEC>;
