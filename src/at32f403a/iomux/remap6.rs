...
pub type SDIO2_GMUX_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
pub type USART2_GMUX_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REMAP6")
            ...
            .field("sdio2_gmux", &self.sdio2_gmux())
            .field("usart1_gmux", &self.usart1_gmux())
            .field("usart2_gmux", &self.usart2_gmux())
...
impl W {
    ...
    #[doc = "Bits 12:15 - SDIO2 muxing"]
    #[inline(always)]
    pub fn sdio2_gmux(&mut self) -> SDIO2_GMUX_W<'_, REMAP6_SPEC> {
        SDIO2_GMUX_W::new(self, 12)
    }
    #[doc = "Bits 16:19 - USART1 muxing"]
    #[inline(always)]
    ...
    #[doc = "Bits 20:23 - USART2 muxing"]
    #[inline(always)]
    pub fn usart2_gmux(&mut self) -> USART2_GMUX_W<'_, REMAP6_SPEC> {
        USART2_GMUX_W::new(self, 20)
    }
    #[doc = "Bits 24:27 - USART3 muxing"]
    #[inline(always)]
