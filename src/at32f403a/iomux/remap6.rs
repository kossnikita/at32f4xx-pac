...
pub type CAN2_GMUX_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
#[doc = "Field `SDIO2_GMUX` reader - SDIO2 muxing"]
pub type SDIO2_GMUX_R = crate::FieldReader;
#[doc = "Field `SDIO2_GMUX` writer - SDIO2 muxing"]
pub type SDIO2_GMUX_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type USART2_GMUX_R = crate::FieldReader;
#[doc = "Field `USART2_GMUX` writer - USART2 muxing"]
pub type USART2_GMUX_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn sdio2_gmux(&self) -> SDIO2_GMUX_R {
        SDIO2_GMUX_R::new(((self.bits >> 12) & 0x0f) as u8)
    }
    ...
    #[inline(always)]
    pub fn usart2_gmux(&self) -> USART2_GMUX_R {
        USART2_GMUX_R::new(((self.bits >> 20) & 0x0f) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can2_gmux(&mut self) -> CAN2_GMUX_W<REMAP6_SPEC, 4> {
        CAN2_GMUX_W::new(self)
    }
    #[doc = "Bits 12:15 - SDIO2 muxing"]
    #[inline(always)]
    #[must_use]
    pub fn sdio2_gmux(&mut self) -> SDIO2_GMUX_W<REMAP6_SPEC, 12> {
        SDIO2_GMUX_W::new(self)
    }
    #[doc = "Bits 16:19 - USART1 muxing"]
    #[inline(always)]
    #[must_use]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usart2_gmux(&mut self) -> USART2_GMUX_W<REMAP6_SPEC, 20> {
        USART2_GMUX_W::new(self)
    }
    #[doc = "Bits 24:27 - USART3 muxing"]
    #[inline(always)]
    #[must_use]
