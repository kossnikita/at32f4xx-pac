...
pub struct RFI0_SPEC;
impl crate::RegisterSpec for RFI0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rfi0::R`](R) reader structure"]
impl crate::Readable for RFI0_SPEC {}
#[doc = "`reset()` method sets RFI0 to value 0"]
impl crate::Resettable for RFI0_SPEC {
