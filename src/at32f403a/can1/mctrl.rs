...
impl FZEN_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> FZENR_A {
        match self.bits {
...
impl DZEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> DZENR_A {
        match self.bits {
...
impl PRSFEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> PRSFENR_A {
        match self.bits {
...
impl AEDEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> AEDENR_A {
        match self.bits {
...
impl AEBOEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> AEBOENR_A {
        match self.bits {
...
impl TTCEN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> TTCENR_A {
        match self.bits {
...
impl SPRST_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> SPRSTR_A {
        match self.bits {
