...
pub type CCOS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `OUTM` reader - Output mode"]
pub type OUTM_R = crate::BitReader;
#[doc = "Field `OUTM` writer - Output mode"]
pub type OUTM_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RTCCAL")
            ...
            .field("ccos", &format_args!("{}", self.ccos().bit()))
            .field("outm", &format_args!("{}", self.outm().bit()))
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccos(&mut self) -> CCOS_W<RTCCAL_SPEC, 10> {
        CCOS_W::new(self)
    }
    #[doc = "Bit 11 - Output mode"]
    #[inline(always)]
    #[must_use]
    pub fn outm(&mut self) -> OUTM_W<RTCCAL_SPEC, 11> {
        OUTM_W::new(self)
    }
