...
pub type DT4_R = crate::FieldReader<u16>;
#[doc = "Field `DT4` writer - BPR data4"]
pub type DT4_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
    #[doc = "Bits 0:15 - BPR data4"]
    #[inline(always)]
    pub fn dt4(&self) -> DT4_R {
        DT4_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - BPR data4"]
    #[inline(always)]
    #[must_use]
    pub fn dt4(&mut self) -> DT4_W<DT4_SPEC, 0> {
        DT4_W::new(self)
    }
