...
impl W {
    #[doc = "Bits 0:3 - Endpoint address"]
    #[inline(always)]
    pub fn eptaddr(&mut self) -> EPTADDR_W<'_, EPT1_SPEC> {
        EPTADDR_W::new(self, 0)
    }
    #[doc = "Bits 4:5 - Tx status"]
    #[inline(always)]
    pub fn txsts(&mut self) -> TXSTS_W<'_, EPT1_SPEC> {
        TXSTS_W::new(self, 4)
    }
    #[doc = "Bit 6 - Tx data toggle synchronization"]
    #[inline(always)]
    pub fn txdts(&mut self) -> TXDTS_W<'_, EPT1_SPEC> {
        TXDTS_W::new(self, 6)
    }
    #[doc = "Bit 7 - Tx transaction completed"]
    #[inline(always)]
    pub fn txtc(&mut self) -> TXTC_W<'_, EPT1_SPEC> {
        TXTC_W::new(self, 7)
    }
    #[doc = "Bit 8 - Endpoint extend function"]
    #[inline(always)]
    pub fn exf(&mut self) -> EXF_W<'_, EPT1_SPEC> {
        EXF_W::new(self, 8)
    }
    #[doc = "Bits 9:10 - Transfer type"]
    #[inline(always)]
    pub fn trans_type(&mut self) -> TRANS_TYPE_W<'_, EPT1_SPEC> {
        TRANS_TYPE_W::new(self, 9)
    }
    #[doc = "Bit 11 - Setup transaction completed"]
    #[inline(always)]
    pub fn setuptc(&mut self) -> SETUPTC_W<'_, EPT1_SPEC> {
        SETUPTC_W::new(self, 11)
    }
    #[doc = "Bits 12:13 - Rx Status"]
    #[inline(always)]
    pub fn rxsts(&mut self) -> RXSTS_W<'_, EPT1_SPEC> {
        RXSTS_W::new(self, 12)
    }
    #[doc = "Bit 14 - Rx data toggle synchronization"]
    #[inline(always)]
    pub fn rxdts(&mut self) -> RXDTS_W<'_, EPT1_SPEC> {
        RXDTS_W::new(self, 14)
    }
    #[doc = "Bit 15 - Rx transaction completed"]
    #[inline(always)]
    pub fn rxtc(&mut self) -> RXTC_W<'_, EPT1_SPEC> {
        RXTC_W::new(self, 15)
    }
}
