...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eptaddr(&mut self) -> EPTADDR_W<EPT4_SPEC, 0> {
        EPTADDR_W::new(self)
    }
    #[doc = "Bits 4:5 - Tx status"]
    #[inline(always)]
    #[must_use]
    pub fn txsts(&mut self) -> TXSTS_W<EPT4_SPEC, 4> {
        TXSTS_W::new(self)
    }
    #[doc = "Bit 6 - Tx data toggle synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn txdts(&mut self) -> TXDTS_W<EPT4_SPEC, 6> {
        TXDTS_W::new(self)
    }
    #[doc = "Bit 7 - Tx transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn txtc(&mut self) -> TXTC_W<EPT4_SPEC, 7> {
        TXTC_W::new(self)
    }
    #[doc = "Bit 8 - Endpoint extend function"]
    #[inline(always)]
    #[must_use]
    pub fn exf(&mut self) -> EXF_W<EPT4_SPEC, 8> {
        EXF_W::new(self)
    }
    #[doc = "Bits 9:10 - Transfer type"]
    #[inline(always)]
    #[must_use]
    pub fn trans_type(&mut self) -> TRANS_TYPE_W<EPT4_SPEC, 9> {
        TRANS_TYPE_W::new(self)
    }
    #[doc = "Bit 11 - Setup transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn setuptc(&mut self) -> SETUPTC_W<EPT4_SPEC, 11> {
        SETUPTC_W::new(self)
    }
    #[doc = "Bits 12:13 - Rx Status"]
    #[inline(always)]
    #[must_use]
    pub fn rxsts(&mut self) -> RXSTS_W<EPT4_SPEC, 12> {
        RXSTS_W::new(self)
    }
    #[doc = "Bit 14 - Rx data toggle synchronization"]
    #[inline(always)]
    #[must_use]
    pub fn rxdts(&mut self) -> RXDTS_W<EPT4_SPEC, 14> {
        RXDTS_W::new(self)
    }
    #[doc = "Bit 15 - Rx transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn rxtc(&mut self) -> RXTC_W<EPT4_SPEC, 15> {
        RXTC_W::new(self)
    }
