...
impl RegisterBlock {
    ...
    #[doc = "0x78 - OTGHS register"]
    #[inline(always)]
    pub const fn otghs(&self) -> &OTGHS {
        &self.otghs
    }
...
pub mod ctrlsts;
#[doc = "OTGHS (rw) register accessor: OTGHS register\n\nYou can [`read`](crate::Reg::read) this register and get [`otghs::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`otghs::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@otghs`] module"]
pub type OTGHS = crate::Reg<otghs::OTGHS_SPEC>;
#[doc = "OTGHS register"]
pub mod otghs;
