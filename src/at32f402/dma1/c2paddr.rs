...
pub type R = crate::R<C2PADDR_SPEC>;
#[doc = "Register `C2PADDR` writer"]
pub type W = crate::W<C2PADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn paddr(&mut self) -> PADDR_W<C2PADDR_SPEC, 0> {
        PADDR_W::new(self)
    }
...
pub struct C2PADDR_SPEC;
impl crate::RegisterSpec for C2PADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c2paddr::R`](R) reader structure"]
impl crate::Readable for C2PADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`c2paddr::W`](W) writer structure"]
impl crate::Writable for C2PADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C2PADDR to value 0"]
impl crate::Resettable for C2PADDR_SPEC {
