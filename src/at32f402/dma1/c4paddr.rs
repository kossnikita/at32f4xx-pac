...
pub type R = crate::R<C4PADDR_SPEC>;
#[doc = "Register `C4PADDR` writer"]
pub type W = crate::W<C4PADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn paddr(&mut self) -> PADDR_W<C4PADDR_SPEC, 0> {
        PADDR_W::new(self)
    }
...
pub struct C4PADDR_SPEC;
impl crate::RegisterSpec for C4PADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c4paddr::R`](R) reader structure"]
impl crate::Readable for C4PADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`c4paddr::W`](W) writer structure"]
impl crate::Writable for C4PADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C4PADDR to value 0"]
impl crate::Resettable for C4PADDR_SPEC {
