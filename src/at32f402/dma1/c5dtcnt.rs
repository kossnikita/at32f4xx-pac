...
pub type R = crate::R<C5DTCNT_SPEC>;
#[doc = "Register `C5DTCNT` writer"]
pub type W = crate::W<C5DTCNT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CNT_W<C5DTCNT_SPEC, 0> {
        CNT_W::new(self)
    }
...
pub struct C5DTCNT_SPEC;
impl crate::RegisterSpec for C5DTCNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c5dtcnt::R`](R) reader structure"]
impl crate::Readable for C5DTCNT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`c5dtcnt::W`](W) writer structure"]
impl crate::Writable for C5DTCNT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C5DTCNT to value 0"]
impl crate::Resettable for C5DTCNT_SPEC {
