...
pub type LINE19_R = crate::BitReader;
#[doc = "Field `LINE19` writer - Line 19 state bit"]
pub type LINE19_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `LINE20` reader - Line 20 state bit"]
pub type LINE20_R = crate::BitReader;
#[doc = "Field `LINE20` writer - Line 20 state bit"]
pub type LINE20_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn line19(&mut self) -> LINE19_W<INTSTS_SPEC, 19> {
        LINE19_W::new(self)
    }
    #[doc = "Bit 20 - Line 20 state bit"]
    #[inline(always)]
    #[must_use]
    pub fn line20(&mut self) -> LINE20_W<INTSTS_SPEC, 20> {
        LINE20_W::new(self)
    }
    #[doc = "Bit 21 - Line 21 state bit"]
    #[inline(always)]
