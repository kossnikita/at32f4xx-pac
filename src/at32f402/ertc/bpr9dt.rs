...
pub type R = crate::R<BPR9DT_SPEC>;
#[doc = "Register `BPR9DT` writer"]
pub type W = crate::W<BPR9DT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dt(&mut self) -> DT_W<BPR9DT_SPEC, 0> {
        DT_W::new(self)
    }
...
pub struct BPR9DT_SPEC;
impl crate::RegisterSpec for BPR9DT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bpr9dt::R`](R) reader structure"]
impl crate::Readable for BPR9DT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`bpr9dt::W`](W) writer structure"]
impl crate::Writable for BPR9DT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets BPR9DT to value 0"]
impl crate::Resettable for BPR9DT_SPEC {
