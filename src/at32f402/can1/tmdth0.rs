...
pub type R = crate::R<TMDTH0_SPEC>;
#[doc = "Register `TMDTH0` writer"]
pub type W = crate::W<TMDTH0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmdt4(&mut self) -> TMDT4_W<TMDTH0_SPEC, 0> {
        TMDT4_W::new(self)
    }
    #[doc = "Bits 8:15 - Transmit mailbox data byte 5"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt5(&mut self) -> TMDT5_W<TMDTH0_SPEC, 8> {
        TMDT5_W::new(self)
    }
    #[doc = "Bits 16:23 - Transmit mailbox data byte 6"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt6(&mut self) -> TMDT6_W<TMDTH0_SPEC, 16> {
        TMDT6_W::new(self)
    }
    #[doc = "Bits 24:31 - Transmit mailbox data byte 7"]
    #[inline(always)]
    #[must_use]
    pub fn tmdt7(&mut self) -> TMDT7_W<TMDTH0_SPEC, 24> {
        TMDT7_W::new(self)
    }
...
pub struct TMDTH0_SPEC;
impl crate::RegisterSpec for TMDTH0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tmdth0::R`](R) reader structure"]
impl crate::Readable for TMDTH0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`tmdth0::W`](W) writer structure"]
impl crate::Writable for TMDTH0_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets TMDTH0 to value 0"]
impl crate::Resettable for TMDTH0_SPEC {
