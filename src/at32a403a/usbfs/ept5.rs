...
pub type R = crate::R<EPT5_SPEC>;
#[doc = "Register `EPT5` writer"]
pub type W = crate::W<EPT5_SPEC>;
...
impl W {
    #[doc = "Bits 0:3 - Endpoint address"]
    #[inline(always)]
    pub fn eptaddr(&mut self) -> EPTADDR_W<'_, EPT5_SPEC> {
        EPTADDR_W::new(self, 0)
    }
    #[doc = "Bits 4:5 - Tx status"]
    #[inline(always)]
    pub fn txsts(&mut self) -> TXSTS_W<'_, EPT5_SPEC> {
        TXSTS_W::new(self, 4)
    }
    #[doc = "Bit 6 - Tx data toggle synchronization"]
    #[inline(always)]
    pub fn txdts(&mut self) -> TXDTS_W<'_, EPT5_SPEC> {
        TXDTS_W::new(self, 6)
    }
    #[doc = "Bit 7 - Tx transaction completed"]
    #[inline(always)]
    pub fn txtc(&mut self) -> TXTC_W<'_, EPT5_SPEC> {
        TXTC_W::new(self, 7)
    }
    #[doc = "Bit 8 - Endpoint extend function"]
    #[inline(always)]
    pub fn exf(&mut self) -> EXF_W<'_, EPT5_SPEC> {
        EXF_W::new(self, 8)
    }
    #[doc = "Bits 9:10 - Transfer type"]
    #[inline(always)]
    pub fn trans_type(&mut self) -> TRANS_TYPE_W<'_, EPT5_SPEC> {
        TRANS_TYPE_W::new(self, 9)
    }
    #[doc = "Bit 11 - Setup transaction completed"]
    #[inline(always)]
    pub fn setuptc(&mut self) -> SETUPTC_W<'_, EPT5_SPEC> {
        SETUPTC_W::new(self, 11)
    }
    #[doc = "Bits 12:13 - Rx Status"]
    #[inline(always)]
    pub fn rxsts(&mut self) -> RXSTS_W<'_, EPT5_SPEC> {
        RXSTS_W::new(self, 12)
    }
    #[doc = "Bit 14 - Rx data toggle synchronization"]
    #[inline(always)]
    pub fn rxdts(&mut self) -> RXDTS_W<'_, EPT5_SPEC> {
        RXDTS_W::new(self, 14)
    }
    #[doc = "Bit 15 - Rx transaction completed"]
    #[inline(always)]
    pub fn rxtc(&mut self) -> RXTC_W<'_, EPT5_SPEC> {
        RXTC_W::new(self, 15)
    }
}
#[doc = "endpoint 5 register\n\nYou can [`read`](crate::Reg::read) this register and get [`ept5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ept5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct EPT5_SPEC;
impl crate::RegisterSpec for EPT5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ept5::R`](R) reader structure"]
impl crate::Readable for EPT5_SPEC {}
#[doc = "`write(|w| ..)` method takes [`ept5::W`](W) writer structure"]
impl crate::Writable for EPT5_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets EPT5 to value 0"]
impl crate::Resettable for EPT5_SPEC {}
