...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nwen(&mut self) -> NWEN_W<BK2CTRL_SPEC, 1> {
        NWEN_W::new(self)
    }
    #[doc = "Bit 2 - Memory bank enable"]
    #[inline(always)]
    #[must_use]
    pub fn en(&mut self) -> EN_W<BK2CTRL_SPEC, 2> {
        EN_W::new(self)
    }
    #[doc = "Bit 3 - Memory device type"]
    #[inline(always)]
    #[must_use]
    pub fn dev(&mut self) -> DEV_W<BK2CTRL_SPEC, 3> {
        DEV_W::new(self)
    }
    #[doc = "Bits 4:5 - External memory data bus width"]
    #[inline(always)]
    #[must_use]
    pub fn extmdbw(&mut self) -> EXTMDBW_W<BK2CTRL_SPEC, 4> {
        EXTMDBW_W::new(self)
    }
    #[doc = "Bit 6 - ECC enable"]
    #[inline(always)]
    #[must_use]
    pub fn eccen(&mut self) -> ECCEN_W<BK2CTRL_SPEC, 6> {
        ECCEN_W::new(self)
    }
    #[doc = "Bits 9:12 - CLE to RE delay"]
    #[inline(always)]
    #[must_use]
    pub fn tcr(&mut self) -> TCR_W<BK2CTRL_SPEC, 9> {
        TCR_W::new(self)
    }
    #[doc = "Bits 13:16 - ALE to RE delay"]
    #[inline(always)]
    #[must_use]
    pub fn tar(&mut self) -> TAR_W<BK2CTRL_SPEC, 13> {
        TAR_W::new(self)
    }
    #[doc = "Bits 17:19 - ECC page size"]
    #[inline(always)]
    #[must_use]
    pub fn eccpgs(&mut self) -> ECCPGS_W<BK2CTRL_SPEC, 17> {
        ECCPGS_W::new(self)
    }
