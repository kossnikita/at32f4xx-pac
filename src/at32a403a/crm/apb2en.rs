...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpioeen(&mut self) -> GPIOEEN_W<APB2EN_SPEC, 6> {
        GPIOEEN_W::new(self)
    }
    #[doc = "Bit 9 - ADC1 clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc2en(&mut self) -> ADC2EN_W<APB2EN_SPEC, 10> {
        ADC2EN_W::new(self)
    }
    #[doc = "Bit 11 - Timer1 clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmr8en(&mut self) -> TMR8EN_W<APB2EN_SPEC, 13> {
        TMR8EN_W::new(self)
    }
    #[doc = "Bit 14 - USART1 clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc3en(&mut self) -> ADC3EN_W<APB2EN_SPEC, 15> {
        ADC3EN_W::new(self)
    }
    #[doc = "Bit 19 - Timer9 clock enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c3en(&mut self) -> I2C3EN_W<APB2EN_SPEC, 23> {
        I2C3EN_W::new(self)
    }
    #[doc = "Bit 24 - USART6 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn usart6en(&mut self) -> USART6EN_W<APB2EN_SPEC, 24> {
        USART6EN_W::new(self)
    }
    #[doc = "Bit 25 - UART7 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn uart7en(&mut self) -> UART7EN_W<APB2EN_SPEC, 25> {
        UART7EN_W::new(self)
    }
    #[doc = "Bit 26 - UART8 clock enable"]
    #[inline(always)]
    #[must_use]
    pub fn uart8en(&mut self) -> UART8EN_W<APB2EN_SPEC, 26> {
        UART8EN_W::new(self)
    }
