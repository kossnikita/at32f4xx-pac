...
impl W {
    ...
    #[doc = "Bit 21 - Ethernet MAC muxing"]
    #[inline(always)]
    pub fn emac_mux(&mut self) -> EMAC_MUX_W<'_, REMAP_SPEC> {
        EMAC_MUX_W::new(self, 21)
    }
    #[doc = "Bit 22 - CAN2 muxing"]
    #[inline(always)]
    pub fn can2_mux(&mut self) -> CAN2_MUX_W<'_, REMAP_SPEC> {
        CAN2_MUX_W::new(self, 22)
    }
    #[doc = "Bit 23 - MII_RMII select muxing"]
    #[inline(always)]
    pub fn mii_rmii_sel_mux(&mut self) -> MII_RMII_SEL_MUX_W<'_, REMAP_SPEC> {
    ...
    #[doc = "Bit 28 - SPI3 muxing"]
    #[inline(always)]
    pub fn spi3_mux(&mut self) -> SPI3_MUX_W<'_, REMAP_SPEC> {
        SPI3_MUX_W::new(self, 28)
    }
    #[doc = "Bit 29 - TMR2 internal trigger 1 muxing"]
    #[inline(always)]
    pub fn tmr2itr1_mux(&mut self) -> TMR2ITR1_MUX_W<'_, REMAP_SPEC> {
        TMR2ITR1_MUX_W::new(self, 29)
    }
    #[doc = "Bit 30 - PTP_PPS muxing"]
    #[inline(always)]
    pub fn ptp_pps_mux(&mut self) -> PTP_PPS_MUX_W<'_, REMAP_SPEC> {
