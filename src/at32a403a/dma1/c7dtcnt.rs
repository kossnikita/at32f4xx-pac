...
pub type R = crate::R<C7DTCNT_SPEC>;
#[doc = "Register `C7DTCNT` writer"]
pub type W = crate::W<C7DTCNT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CNT_W<C7DTCNT_SPEC, 0> {
        CNT_W::new(self)
    }
...
pub struct C7DTCNT_SPEC;
impl crate::RegisterSpec for C7DTCNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c7dtcnt::R`](R) reader structure"]
impl crate::Readable for C7DTCNT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`c7dtcnt::W`](W) writer structure"]
impl crate::Writable for C7DTCNT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C7DTCNT to value 0"]
impl crate::Resettable for C7DTCNT_SPEC {
