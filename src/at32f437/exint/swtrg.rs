...
pub type SWT19_R = crate::BitReader;
#[doc = "Field `SWT19` writer - Software triggle on line 19"]
pub type SWT19_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `SWT20` reader - Software triggle on line 20"]
pub type SWT20_R = crate::BitReader;
#[doc = "Field `SWT20` writer - Software triggle on line 20"]
pub type SWT20_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn swt20(&self) -> SWT20_R {
        SWT20_R::new(((self.bits >> 20) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swt20(&mut self) -> SWT20_W<SWTRG_SPEC, 20> {
        SWT20_W::new(self)
    }
    #[doc = "Bit 21 - Software triggle on line 21"]
    #[inline(always)]
