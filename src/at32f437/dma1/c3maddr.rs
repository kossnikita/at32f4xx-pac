...
pub type R = crate::R<C3MADDR_SPEC>;
#[doc = "Register `C3MADDR` writer"]
pub type W = crate::W<C3MADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn maddr(&mut self) -> MADDR_W<C3MADDR_SPEC, 0> {
        MADDR_W::new(self)
    }
...
pub struct C3MADDR_SPEC;
impl crate::RegisterSpec for C3MADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c3maddr::R`](R) reader structure"]
impl crate::Readable for C3MADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`c3maddr::W`](W) writer structure"]
impl crate::Writable for C3MADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C3MADDR to value 0"]
impl crate::Resettable for C3MADDR_SPEC {
