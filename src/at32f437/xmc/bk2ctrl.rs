...
impl W {
    #[doc = "Bit 1 - Wait feature enable"]
    #[inline(always)]
    pub fn nwen(&mut self) -> NWEN_W<'_, BK2CTRL_SPEC> {
        NWEN_W::new(self, 1)
    }
    #[doc = "Bit 2 - Memory bank enable"]
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, BK2CTRL_SPEC> {
        EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - Memory device type"]
    #[inline(always)]
    pub fn dev(&mut self) -> DEV_W<'_, BK2CTRL_SPEC> {
        DEV_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - External memory data bus width"]
    #[inline(always)]
    pub fn extmdbw(&mut self) -> EXTMDBW_W<'_, BK2CTRL_SPEC> {
        EXTMDBW_W::new(self, 4)
    }
    #[doc = "Bit 6 - ECC enable"]
    #[inline(always)]
    pub fn eccen(&mut self) -> ECCEN_W<'_, BK2CTRL_SPEC> {
        ECCEN_W::new(self, 6)
    }
    #[doc = "Bits 9:12 - CLE to RE delay"]
    #[inline(always)]
    pub fn tcr(&mut self) -> TCR_W<'_, BK2CTRL_SPEC> {
        TCR_W::new(self, 9)
    }
    #[doc = "Bits 13:16 - ALE to RE delay"]
    #[inline(always)]
    pub fn tar(&mut self) -> TAR_W<'_, BK2CTRL_SPEC> {
        TAR_W::new(self, 13)
    }
    #[doc = "Bits 17:19 - ECC page size"]
    #[inline(always)]
    pub fn eccpgs(&mut self) -> ECCPGS_W<'_, BK2CTRL_SPEC> {
