...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn res(&mut self) -> RES_W<BK3IS_SPEC> {
        RES_W::new(self, 0)
    }
    #[doc = "Bit 1 - High-level status"]
    #[inline(always)]
    #[must_use]
    pub fn hls(&mut self) -> HLS_W<BK3IS_SPEC> {
        HLS_W::new(self, 1)
    }
    #[doc = "Bit 2 - Falling edge status"]
    #[inline(always)]
    #[must_use]
    pub fn fes(&mut self) -> FES_W<BK3IS_SPEC> {
        FES_W::new(self, 2)
    }
    #[doc = "Bit 3 - Rising edge interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn reien(&mut self) -> REIEN_W<BK3IS_SPEC> {
        REIEN_W::new(self, 3)
    }
    #[doc = "Bit 4 - High-level interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn hlien(&mut self) -> HLIEN_W<BK3IS_SPEC> {
        HLIEN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Falling edge interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn feien(&mut self) -> FEIEN_W<BK3IS_SPEC> {
        FEIEN_W::new(self, 5)
    }
}
