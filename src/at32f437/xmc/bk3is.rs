...
pub type R = crate::R<BK3IS_SPEC>;
#[doc = "Register `BK3IS` writer"]
pub type W = crate::W<BK3IS_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Rising edge capture status"]
    #[inline(always)]
    pub fn res(&mut self) -> RES_W<'_, BK3IS_SPEC> {
        RES_W::new(self, 0)
    }
    #[doc = "Bit 1 - High-level status"]
    #[inline(always)]
    pub fn hls(&mut self) -> HLS_W<'_, BK3IS_SPEC> {
        HLS_W::new(self, 1)
    }
    #[doc = "Bit 2 - Falling edge status"]
    #[inline(always)]
    pub fn fes(&mut self) -> FES_W<'_, BK3IS_SPEC> {
        FES_W::new(self, 2)
    }
    #[doc = "Bit 3 - Rising edge interrupt enable"]
    #[inline(always)]
    pub fn reien(&mut self) -> REIEN_W<'_, BK3IS_SPEC> {
        REIEN_W::new(self, 3)
    }
    #[doc = "Bit 4 - High-level interrupt enable"]
    #[inline(always)]
    pub fn hlien(&mut self) -> HLIEN_W<'_, BK3IS_SPEC> {
        HLIEN_W::new(self, 4)
    }
    #[doc = "Bit 5 - Falling edge interrupt enable"]
    #[inline(always)]
    pub fn feien(&mut self) -> FEIEN_W<'_, BK3IS_SPEC> {
        FEIEN_W::new(self, 5)
    }
}
#[doc = "FIFO status and interrupt register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`bk3is::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bk3is::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BK3IS_SPEC;
impl crate::RegisterSpec for BK3IS_SPEC {
    type Ux = u32;
}
