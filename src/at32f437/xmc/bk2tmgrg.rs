...
impl W {
    #[doc = "Bits 0:7 - Regular memory setup time"]
    #[inline(always)]
    pub fn rgst(&mut self) -> RGST_W<'_, BK2TMGRG_SPEC> {
        RGST_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Regular memory wait time"]
    #[inline(always)]
    pub fn rgwt(&mut self) -> RGWT_W<'_, BK2TMGRG_SPEC> {
        RGWT_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Regular memory hold time"]
    #[inline(always)]
    pub fn rght(&mut self) -> RGHT_W<'_, BK2TMGRG_SPEC> {
        RGHT_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Regular memory databus High resistance time"]
    #[inline(always)]
    pub fn rgdhizt(&mut self) -> RGDHIZT_W<'_, BK2TMGRG_SPEC> {
        RGDHIZT_W::new(self, 24)
    }
}
#[doc = "Regular memory space timing register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`bk2tmgrg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bk2tmgrg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
