...
pub type R = crate::R<BK2TMGSP_SPEC>;
#[doc = "Register `BK2TMGSP` writer"]
pub type W = crate::W<BK2TMGSP_SPEC>;
...
impl W {
    #[doc = "Bits 0:7 - special memory setup time"]
    #[inline(always)]
    pub fn spst(&mut self) -> SPST_W<'_, BK2TMGSP_SPEC> {
        SPST_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - special memory wait time"]
    #[inline(always)]
    pub fn spwt(&mut self) -> SPWT_W<'_, BK2TMGSP_SPEC> {
        SPWT_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - special memory hold time"]
    #[inline(always)]
    pub fn spht(&mut self) -> SPHT_W<'_, BK2TMGSP_SPEC> {
        SPHT_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - special memory databus High resistance time"]
    #[inline(always)]
    pub fn spdhizt(&mut self) -> SPDHIZT_W<'_, BK2TMGSP_SPEC> {
        SPDHIZT_W::new(self, 24)
    }
}
#[doc = "special memory space timing register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`bk2tmgsp::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bk2tmgsp::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BK2TMGSP_SPEC;
impl crate::RegisterSpec for BK2TMGSP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bk2tmgsp::R`](R) reader structure"]
impl crate::Readable for BK2TMGSP_SPEC {}
#[doc = "`write(|w| ..)` method takes [`bk2tmgsp::W`](W) writer structure"]
impl crate::Writable for BK2TMGSP_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BK2TMGSP to value 0xfcfc_fcfc"]
impl crate::Resettable for BK2TMGSP_SPEC {
