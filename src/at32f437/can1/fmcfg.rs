...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sel14(&mut self) -> SEL_W<FMCFG_SPEC, 14> {
        SEL_W::new(self)
    }
    #[doc = "Bit 15 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel15(&mut self) -> SEL_W<FMCFG_SPEC, 15> {
        SEL_W::new(self)
    }
    #[doc = "Bit 16 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel16(&mut self) -> SEL_W<FMCFG_SPEC, 16> {
        SEL_W::new(self)
    }
    #[doc = "Bit 17 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel17(&mut self) -> SEL_W<FMCFG_SPEC, 17> {
        SEL_W::new(self)
    }
    #[doc = "Bit 18 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel18(&mut self) -> SEL_W<FMCFG_SPEC, 18> {
        SEL_W::new(self)
    }
    #[doc = "Bit 19 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel19(&mut self) -> SEL_W<FMCFG_SPEC, 19> {
        SEL_W::new(self)
    }
    #[doc = "Bit 20 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel20(&mut self) -> SEL_W<FMCFG_SPEC, 20> {
        SEL_W::new(self)
    }
    #[doc = "Bit 21 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel21(&mut self) -> SEL_W<FMCFG_SPEC, 21> {
        SEL_W::new(self)
    }
    #[doc = "Bit 22 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel22(&mut self) -> SEL_W<FMCFG_SPEC, 22> {
        SEL_W::new(self)
    }
    #[doc = "Bit 23 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel23(&mut self) -> SEL_W<FMCFG_SPEC, 23> {
        SEL_W::new(self)
    }
    #[doc = "Bit 24 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel24(&mut self) -> SEL_W<FMCFG_SPEC, 24> {
        SEL_W::new(self)
    }
    #[doc = "Bit 25 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel25(&mut self) -> SEL_W<FMCFG_SPEC, 25> {
        SEL_W::new(self)
    }
    #[doc = "Bit 26 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel26(&mut self) -> SEL_W<FMCFG_SPEC, 26> {
        SEL_W::new(self)
    }
    #[doc = "Bit 27 - Filter mode select"]
    #[inline(always)]
    #[must_use]
    pub fn sel27(&mut self) -> SEL_W<FMCFG_SPEC, 27> {
        SEL_W::new(self)
    }
