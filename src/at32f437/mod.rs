#![doc = "Peripheral access API for AT32F437 microcontrollers (generated using svd2rust v0.30.1 (aeb9043 2023-10-18))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
#[doc = "USB on the go full speed"]
pub struct USB_OTG2_GLOBAL {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for USB_OTG2_GLOBAL {}
impl USB_OTG2_GLOBAL {
    #[doc = r"Pointer to the register block"]
...
impl Deref for USB_OTG2_GLOBAL {
...
#[doc = "USB on the go full speed"]
pub struct USB_OTG2_HOST {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for USB_OTG2_HOST {}
impl USB_OTG2_HOST {
    #[doc = r"Pointer to the register block"]
...
#[doc = "USB on the go full speed"]
pub struct USB_OTG2_DEVICE {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for USB_OTG2_DEVICE {}
impl USB_OTG2_DEVICE {
    #[doc = r"Pointer to the register block"]
...
impl Deref for USB_OTG2_DEVICE {
...
#[doc = "USB on the go full speed"]
pub struct USB_OTG2_PWRCLK {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for USB_OTG2_PWRCLK {}
impl USB_OTG2_PWRCLK {
    #[doc = r"Pointer to the register block"]
...
impl Deref for USB_OTG2_PWRCLK {
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            USB_OTG2_GLOBAL: USB_OTG2_GLOBAL {
                _marker: PhantomData,
            },
            USB_OTG2_HOST: USB_OTG2_HOST {
                _marker: PhantomData,
            },
            USB_OTG2_DEVICE: USB_OTG2_DEVICE {
                _marker: PhantomData,
            },
            USB_OTG2_PWRCLK: USB_OTG2_PWRCLK {
                _marker: PhantomData,
            },
            SCFG: SCFG {
                _marker: PhantomData,
