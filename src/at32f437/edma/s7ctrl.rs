...
impl core::fmt::Debug for crate::generic::Reg<S7CTRL_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sen(&mut self) -> SEN_W<S7CTRL_SPEC, 0> {
        SEN_W::new(self)
    }
    #[doc = "Bit 1 - Direct mode error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrien(&mut self) -> DMERRIEN_W<S7CTRL_SPEC, 1> {
        DMERRIEN_W::new(self)
    }
    #[doc = "Bit 2 - Transfer error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dterrien(&mut self) -> DTERRIEN_W<S7CTRL_SPEC, 2> {
        DTERRIEN_W::new(self)
    }
    #[doc = "Bit 3 - Half data transfer interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn hdtien(&mut self) -> HDTIEN_W<S7CTRL_SPEC, 3> {
        HDTIEN_W::new(self)
    }
    #[doc = "Bit 4 - Full data transfer complete interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fdtien(&mut self) -> FDTIEN_W<S7CTRL_SPEC, 4> {
        FDTIEN_W::new(self)
    }
    #[doc = "Bit 5 - Peripheral flow controller"]
    #[inline(always)]
    #[must_use]
    pub fn pfctrl(&mut self) -> PFCTRL_W<S7CTRL_SPEC, 5> {
        PFCTRL_W::new(self)
    }
    #[doc = "Bits 6:7 - Data transfer direction"]
    #[inline(always)]
    #[must_use]
    pub fn dtd(&mut self) -> DTD_W<S7CTRL_SPEC, 6> {
        DTD_W::new(self)
    }
    #[doc = "Bit 8 - Loop mode"]
    #[inline(always)]
    #[must_use]
    pub fn lm(&mut self) -> LM_W<S7CTRL_SPEC, 8> {
        LM_W::new(self)
    }
    #[doc = "Bit 9 - Peripheral increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn pincm(&mut self) -> PINCM_W<S7CTRL_SPEC, 9> {
        PINCM_W::new(self)
    }
    #[doc = "Bit 10 - Memory increment mode"]
    #[inline(always)]
    #[must_use]
    pub fn mincm(&mut self) -> MINCM_W<S7CTRL_SPEC, 10> {
        MINCM_W::new(self)
    }
    #[doc = "Bits 11:12 - Peripheral data width"]
    #[inline(always)]
    #[must_use]
    pub fn pwidth(&mut self) -> PWIDTH_W<S7CTRL_SPEC, 11> {
        PWIDTH_W::new(self)
    }
    #[doc = "Bits 13:14 - Memory data width"]
    #[inline(always)]
    #[must_use]
    pub fn mwidth(&mut self) -> MWIDTH_W<S7CTRL_SPEC, 13> {
        MWIDTH_W::new(self)
    }
    #[doc = "Bit 15 - Peripheral increment offset size"]
    #[inline(always)]
    #[must_use]
    pub fn pincos(&mut self) -> PINCOS_W<S7CTRL_SPEC, 15> {
        PINCOS_W::new(self)
    }
    #[doc = "Bits 16:17 - Stream priority level"]
    #[inline(always)]
    #[must_use]
    pub fn spl(&mut self) -> SPL_W<S7CTRL_SPEC, 16> {
        SPL_W::new(self)
    }
    #[doc = "Bit 18 - Double memory mode"]
    #[inline(always)]
    #[must_use]
    pub fn dmm(&mut self) -> DMM_W<S7CTRL_SPEC, 18> {
        DMM_W::new(self)
    }
    #[doc = "Bit 19 - Current memory (only in double buffer mode)"]
    #[inline(always)]
    #[must_use]
    pub fn cm(&mut self) -> CM_W<S7CTRL_SPEC, 19> {
        CM_W::new(self)
    }
    #[doc = "Bits 21:22 - Peripheral burst transmission"]
    #[inline(always)]
    #[must_use]
    pub fn pburst(&mut self) -> PBURST_W<S7CTRL_SPEC, 21> {
        PBURST_W::new(self)
    }
    #[doc = "Bits 23:24 - Memory burst transmission"]
    #[inline(always)]
    #[must_use]
    pub fn mburst(&mut self) -> MBURST_W<S7CTRL_SPEC, 23> {
        MBURST_W::new(self)
    }
