...
pub type R = crate::R<S2_2DCNT_SPEC>;
#[doc = "Register `S2_2DCNT` writer"]
pub type W = crate::W<S2_2DCNT_SPEC>;
...
#[doc = "Stream 2 2D Transfer Count\n\nYou can [`read`](crate::Reg::read) this register and get [`s2_2dcnt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s2_2dcnt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S2_2DCNT_SPEC;
impl crate::RegisterSpec for S2_2DCNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`s2_2dcnt::R`](R) reader structure"]
impl crate::Readable for S2_2DCNT_SPEC {}
