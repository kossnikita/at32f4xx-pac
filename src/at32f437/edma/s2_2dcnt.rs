...
impl core::fmt::Debug for crate::generic::Reg<S2_2DCNT_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xconut(&mut self) -> XCONUT_W<S2_2DCNT_SPEC, 0> {
        XCONUT_W::new(self)
    }
    #[doc = "Bits 16:31 - Y dimension transfer count"]
    #[inline(always)]
    #[must_use]
    pub fn yconut(&mut self) -> YCONUT_W<S2_2DCNT_SPEC, 16> {
        YCONUT_W::new(self)
    }
