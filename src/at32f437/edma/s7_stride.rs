...
impl core::fmt::Debug for crate::generic::Reg<S7_STRIDE_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srcstd(&mut self) -> SRCSTD_W<S7_STRIDE_SPEC, 0> {
        SRCSTD_W::new(self)
    }
    #[doc = "Bits 16:31 - Destination stride"]
    #[inline(always)]
    #[must_use]
    pub fn dststd(&mut self) -> DSTSTD_W<S7_STRIDE_SPEC, 16> {
        DSTSTD_W::new(self)
    }
