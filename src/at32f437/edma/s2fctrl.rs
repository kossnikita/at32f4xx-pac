...
impl core::fmt::Debug for crate::generic::Reg<S2FCTRL_SPEC> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fthsel(&mut self) -> FTHSEL_W<S2FCTRL_SPEC, 0> {
        FTHSEL_W::new(self)
    }
    #[doc = "Bit 2 - FIFO mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn fen(&mut self) -> FEN_W<S2FCTRL_SPEC, 2> {
        FEN_W::new(self)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ferrien(&mut self) -> FERRIEN_W<S2FCTRL_SPEC, 7> {
        FERRIEN_W::new(self)
    }
