...
impl W {
    #[doc = "Bits 0:31 - Peripheral address"]
    #[inline(always)]
    pub fn paddr(&mut self) -> PADDR_W<'_, S5PADDR_SPEC> {
        PADDR_W::new(self, 0)
    }
}
#[doc = "stream 5 peripheral address register\n\nYou can [`read`](crate::Reg::read) this register and get [`s5paddr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s5paddr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
