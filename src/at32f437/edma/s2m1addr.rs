...
pub type R = crate::R<S2M1ADDR_SPEC>;
#[doc = "Register `S2M1ADDR` writer"]
pub type W = crate::W<S2M1ADDR_SPEC>;
...
impl W {
    #[doc = "Bits 0:31 - Memory 1 address (used in case of Double buffer mode)"]
    #[inline(always)]
    pub fn m1addr(&mut self) -> M1ADDR_W<'_, S2M1ADDR_SPEC> {
        M1ADDR_W::new(self, 0)
    }
}
#[doc = "stream 2 memory 1 address register\n\nYou can [`read`](crate::Reg::read) this register and get [`s2m1addr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s2m1addr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct S2M1ADDR_SPEC;
impl crate::RegisterSpec for S2M1ADDR_SPEC {
    type Ux = u32;
}
