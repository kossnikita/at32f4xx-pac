...
pub type FERRFC5_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMERRFC5_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FERRFC6_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMERRFC6_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DTERRFC6_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HDTFC6_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FDTFC6_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FERRFC7_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMERRFC7_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DTERRFC7_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HDTFC7_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FDTFC7_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FERRFC8_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DMERRFC8_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DTERRFC8_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HDTFC8_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FDTFC8_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CLR2")
            .field("fdtfc8", &format_args!("{}", self.fdtfc8().bit()))
            .field("hdtfc8", &format_args!("{}", self.hdtfc8().bit()))
            .field("dterrfc8", &format_args!("{}", self.dterrfc8().bit()))
            .field("dmerrfc8", &format_args!("{}", self.dmerrfc8().bit()))
            .field("ferrfc8", &format_args!("{}", self.ferrfc8().bit()))
            .field("fdtfc7", &format_args!("{}", self.fdtfc7().bit()))
            .field("hdtfc7", &format_args!("{}", self.hdtfc7().bit()))
            .field("dterrfc7", &format_args!("{}", self.dterrfc7().bit()))
            .field("dmerrfc7", &format_args!("{}", self.dmerrfc7().bit()))
            .field("ferrfc7", &format_args!("{}", self.ferrfc7().bit()))
            .field("fdtfc6", &format_args!("{}", self.fdtfc6().bit()))
            .field("hdtfc6", &format_args!("{}", self.hdtfc6().bit()))
            .field("dterrfc6", &format_args!("{}", self.dterrfc6().bit()))
            .field("dmerrfc6", &format_args!("{}", self.dmerrfc6().bit()))
            .field("ferrfc6", &format_args!("{}", self.ferrfc6().bit()))
            ...
            .field("dmerrfc5", &format_args!("{}", self.dmerrfc5().bit()))
            .field("ferrfc5", &format_args!("{}", self.ferrfc5().bit()))
            .finish()
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ferrfc5(&mut self) -> FERRFC5_W<CLR2_SPEC, 0> {
        FERRFC5_W::new(self)
    }
    #[doc = "Bit 2 - Stream 5 clear direct mode error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrfc5(&mut self) -> DMERRFC5_W<CLR2_SPEC, 2> {
        DMERRFC5_W::new(self)
    }
    #[doc = "Bit 3 - Stream 5 clear transfer error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc5(&mut self) -> DTERRFC5_W<CLR2_SPEC, 3> {
        DTERRFC5_W::new(self)
    }
    #[doc = "Bit 4 - Stream 5 clear half data transfer interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc5(&mut self) -> HDTFC5_W<CLR2_SPEC, 4> {
        HDTFC5_W::new(self)
    }
    #[doc = "Bit 5 - Stream 5 clear full data transfer complete interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc5(&mut self) -> FDTFC5_W<CLR2_SPEC, 5> {
        FDTFC5_W::new(self)
    }
    #[doc = "Bit 6 - Stream 6 clear FIFO error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ferrfc6(&mut self) -> FERRFC6_W<CLR2_SPEC, 6> {
        FERRFC6_W::new(self)
    }
    #[doc = "Bit 8 - Stream 6 clear direct mode error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrfc6(&mut self) -> DMERRFC6_W<CLR2_SPEC, 8> {
        DMERRFC6_W::new(self)
    }
    #[doc = "Bit 9 - Stream 6 clear transfer error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc6(&mut self) -> DTERRFC6_W<CLR2_SPEC, 9> {
        DTERRFC6_W::new(self)
    }
    #[doc = "Bit 10 - Stream 6 clear half data transfer interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc6(&mut self) -> HDTFC6_W<CLR2_SPEC, 10> {
        HDTFC6_W::new(self)
    }
    #[doc = "Bit 11 - Stream 6 clear full data transfer complete interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc6(&mut self) -> FDTFC6_W<CLR2_SPEC, 11> {
        FDTFC6_W::new(self)
    }
    #[doc = "Bit 16 - Stream 7 clear FIFO error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ferrfc7(&mut self) -> FERRFC7_W<CLR2_SPEC, 16> {
        FERRFC7_W::new(self)
    }
    #[doc = "Bit 18 - Stream 7 clear direct mode error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrfc7(&mut self) -> DMERRFC7_W<CLR2_SPEC, 18> {
        DMERRFC7_W::new(self)
    }
    #[doc = "Bit 19 - Stream 7 clear transfer error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc7(&mut self) -> DTERRFC7_W<CLR2_SPEC, 19> {
        DTERRFC7_W::new(self)
    }
    #[doc = "Bit 20 - Stream 7 clear half data transfer interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc7(&mut self) -> HDTFC7_W<CLR2_SPEC, 20> {
        HDTFC7_W::new(self)
    }
    #[doc = "Bit 21 - Stream 7 clear full data transfer complete interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc7(&mut self) -> FDTFC7_W<CLR2_SPEC, 21> {
        FDTFC7_W::new(self)
    }
    #[doc = "Bit 22 - Stream 8 clear FIFO error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ferrfc8(&mut self) -> FERRFC8_W<CLR2_SPEC, 22> {
        FERRFC8_W::new(self)
    }
    #[doc = "Bit 24 - Stream 8 clear direct mode error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dmerrfc8(&mut self) -> DMERRFC8_W<CLR2_SPEC, 24> {
        DMERRFC8_W::new(self)
    }
    #[doc = "Bit 25 - Stream 8 clear transfer error interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dterrfc8(&mut self) -> DTERRFC8_W<CLR2_SPEC, 25> {
        DTERRFC8_W::new(self)
    }
    #[doc = "Bit 26 - Stream 8 clear half data transfer interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn hdtfc8(&mut self) -> HDTFC8_W<CLR2_SPEC, 26> {
        HDTFC8_W::new(self)
    }
    #[doc = "Bit 27 - Stream 8 clear full data transfer complete interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn fdtfc8(&mut self) -> FDTFC8_W<CLR2_SPEC, 27> {
        FDTFC8_W::new(self)
    }
