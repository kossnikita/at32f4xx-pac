...
impl W {
    #[doc = "Bits 0:15 - Source stride"]
    #[inline(always)]
    pub fn srcstd(&mut self) -> SRCSTD_W<'_, S6_STRIDE_SPEC> {
        SRCSTD_W::new(self, 0)
    }
    #[doc = "Bits 16:31 - Destination stride"]
    #[inline(always)]
    pub fn dststd(&mut self) -> DSTSTD_W<'_, S6_STRIDE_SPEC> {
        DSTSTD_W::new(self, 16)
    }
}
#[doc = "Stream 6 2D Transfer Stride\n\nYou can [`read`](crate::Reg::read) this register and get [`s6_stride::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s6_stride::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
