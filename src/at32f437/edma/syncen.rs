...
pub type S1SYNC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S2SYNC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S3SYNC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S4SYNC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S5SYNC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S6SYNC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S7SYNC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type S8SYNC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn s1sync(&mut self) -> S1SYNC_W<SYNCEN_SPEC, 0> {
        S1SYNC_W::new(self)
    }
    #[doc = "Bit 1 - Stream 2 sync enable"]
    #[inline(always)]
    #[must_use]
    pub fn s2sync(&mut self) -> S2SYNC_W<SYNCEN_SPEC, 1> {
        S2SYNC_W::new(self)
    }
    #[doc = "Bit 2 - Stream 3 sync enable"]
    #[inline(always)]
    #[must_use]
    pub fn s3sync(&mut self) -> S3SYNC_W<SYNCEN_SPEC, 2> {
        S3SYNC_W::new(self)
    }
    #[doc = "Bit 3 - Stream 4 sync enable"]
    #[inline(always)]
    #[must_use]
    pub fn s4sync(&mut self) -> S4SYNC_W<SYNCEN_SPEC, 3> {
        S4SYNC_W::new(self)
    }
    #[doc = "Bit 4 - Stream 5 sync enable"]
    #[inline(always)]
    #[must_use]
    pub fn s5sync(&mut self) -> S5SYNC_W<SYNCEN_SPEC, 4> {
        S5SYNC_W::new(self)
    }
    #[doc = "Bit 5 - Stream 6 sync enable"]
    #[inline(always)]
    #[must_use]
    pub fn s6sync(&mut self) -> S6SYNC_W<SYNCEN_SPEC, 5> {
        S6SYNC_W::new(self)
    }
    #[doc = "Bit 6 - Stream 7 sync enable"]
    #[inline(always)]
    #[must_use]
    pub fn s7sync(&mut self) -> S7SYNC_W<SYNCEN_SPEC, 6> {
        S7SYNC_W::new(self)
    }
    #[doc = "Bit 7 - Stream 8 sync enable"]
    #[inline(always)]
    #[must_use]
    pub fn s8sync(&mut self) -> S8SYNC_W<SYNCEN_SPEC, 7> {
        S8SYNC_W::new(self)
    }
