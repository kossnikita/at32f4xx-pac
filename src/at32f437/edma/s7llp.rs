...
impl W {
    #[doc = "Bits 0:31 - Link list pointer"]
    #[inline(always)]
    pub fn llp(&mut self) -> LLP_W<'_, S7LLP_SPEC> {
        LLP_W::new(self, 0)
    }
}
#[doc = "Stream 7 Link List Pointer\n\nYou can [`read`](crate::Reg::read) this register and get [`s7llp::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`s7llp::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
