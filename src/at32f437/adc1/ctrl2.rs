...
pub type PCTESEL_L_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type OCTESEL_L_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pctesel_l(&mut self) -> PCTESEL_L_W<CTRL2_SPEC, 16> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pctesel_h(&mut self) -> PCTESEL_H_W<CTRL2_SPEC, 23> {
        PCTESEL_H_W::new(self)
    }
    #[doc = "Bits 24:27 - Low bit of trigger event select for ordinary channels conversion"]
    #[inline(always)]
    #[must_use]
    pub fn octesel_l(&mut self) -> OCTESEL_L_W<CTRL2_SPEC, 24> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn octesel_h(&mut self) -> OCTESEL_H_W<CTRL2_SPEC, 31> {
