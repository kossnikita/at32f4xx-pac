...
impl W {
    #[doc = "Bits 0:6 - A/D Calibration value"]
    #[inline(always)]
    pub fn calval(&mut self) -> CALVAL_W<'_, CALVAL_SPEC> {
        CALVAL_W::new(self, 0)
    }
}
#[doc = "Calibration value register\n\nYou can [`read`](crate::Reg::read) this register and get [`calval::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`calval::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
