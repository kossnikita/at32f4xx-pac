...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clkout1_sel(&mut self) -> CLKOUT1_SEL_W<CFG_SPEC> {
        CLKOUT1_SEL_W::new(self, 21)
    }
    #[doc = "Bits 24:26 - Clock output1 division1"]
    #[inline(always)]
    #[must_use]
    pub fn clkout1div1(&mut self) -> CLKOUT1DIV1_W<CFG_SPEC> {
        CLKOUT1DIV1_W::new(self, 24)
    }
    #[doc = "Bits 27:29 - Clock output2 division1"]
    #[inline(always)]
    #[must_use]
    pub fn clkout2div1(&mut self) -> CLKOUT2DIV1_W<CFG_SPEC> {
        CLKOUT2DIV1_W::new(self, 27)
    }
    #[doc = "Bits 30:31 - Clock output2 selection1"]
    #[inline(always)]
    #[must_use]
    pub fn clkout2_sel1(&mut self) -> CLKOUT2_SEL1_W<CFG_SPEC> {
