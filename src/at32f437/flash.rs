...
pub struct RegisterBlock {
    ...
    pub slib_set_range0: SLIB_SET_RANGE0,
    #[doc = "0xe4 - Configure sLib range register 1"]
    pub slib_set_range1: SLIB_SET_RANGE1,
    _reserved23: [u8; 0x08],
