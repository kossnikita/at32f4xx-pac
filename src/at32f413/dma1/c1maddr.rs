...
pub type R = crate::R<C1MADDR_SPEC>;
#[doc = "Register `C1MADDR` writer"]
pub type W = crate::W<C1MADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn maddr(&mut self) -> MADDR_W<C1MADDR_SPEC, 0> {
        MADDR_W::new(self)
    }
...
pub struct C1MADDR_SPEC;
impl crate::RegisterSpec for C1MADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1maddr::R`](R) reader structure"]
impl crate::Readable for C1MADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`c1maddr::W`](W) writer structure"]
impl crate::Writable for C1MADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets C1MADDR to value 0"]
impl crate::Resettable for C1MADDR_SPEC {
