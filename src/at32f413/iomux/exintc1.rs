...
impl W {
    #[doc = "Bits 0:3 - Configure EXINT0 source"]
    #[inline(always)]
    pub fn exint0(&mut self) -> EXINT0_W<'_, EXINTC1_SPEC> {
        EXINT0_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Configure EXINT1 source"]
    #[inline(always)]
    pub fn exint1(&mut self) -> EXINT1_W<'_, EXINTC1_SPEC> {
        EXINT1_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Configure EXINT2 source"]
    #[inline(always)]
    pub fn exint2(&mut self) -> EXINT2_W<'_, EXINTC1_SPEC> {
        EXINT2_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Configure EXINT3 source"]
    #[inline(always)]
    pub fn exint3(&mut self) -> EXINT3_W<'_, EXINTC1_SPEC> {
