...
pub type EMAC_GMUX_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("REMAP8")
            .field("emac_gmux", &format_args!("{}", self.emac_gmux().bits()))
            .field(
                "mii_rmii_sel_gmux",
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn emac_gmux(&mut self) -> EMAC_GMUX_W<REMAP8_SPEC, 16> {
        EMAC_GMUX_W::new(self)
    }
    #[doc = "Bit 18 - MII_RMII select muxing"]
    #[inline(always)]
    #[must_use]
