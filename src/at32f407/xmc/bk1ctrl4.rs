...
pub type R = crate::R<BK1CTRL4_SPEC>;
#[doc = "Register `BK1CTRL4` writer"]
pub type W = crate::W<BK1CTRL4_SPEC>;
...
#[doc = "SRAM/NOR-Flash chip-select control register 4\n\nYou can [`read`](crate::Reg::read) this register and get [`bk1ctrl4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bk1ctrl4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BK1CTRL4_SPEC;
impl crate::RegisterSpec for BK1CTRL4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bk1ctrl4::R`](R) reader structure"]
impl crate::Readable for BK1CTRL4_SPEC {}
