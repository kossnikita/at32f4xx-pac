...
pub type R = crate::R<BK1CTRL1_SPEC>;
#[doc = "Register `BK1CTRL1` writer"]
pub type W = crate::W<BK1CTRL1_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Memory bank enable"]
    #[inline(always)]
    pub fn en(&mut self) -> EN_W<'_, BK1CTRL1_SPEC> {
        EN_W::new(self, 0)
    }
    #[doc = "Bit 1 - Address and data multiplexing enable"]
    #[inline(always)]
    pub fn admuxen(&mut self) -> ADMUXEN_W<'_, BK1CTRL1_SPEC> {
        ADMUXEN_W::new(self, 1)
    }
    #[doc = "Bits 2:3 - Memory device type"]
    #[inline(always)]
    pub fn dev(&mut self) -> DEV_W<'_, BK1CTRL1_SPEC> {
        DEV_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - External memory data bus width"]
    #[inline(always)]
    pub fn extmdbw(&mut self) -> EXTMDBW_W<'_, BK1CTRL1_SPEC> {
        EXTMDBW_W::new(self, 4)
    }
    #[doc = "Bit 6 - Nor flash access enable"]
    #[inline(always)]
    pub fn noren(&mut self) -> NOREN_W<'_, BK1CTRL1_SPEC> {
        NOREN_W::new(self, 6)
    }
    #[doc = "Bit 8 - Synchronous burst enable"]
    #[inline(always)]
    pub fn syncben(&mut self) -> SYNCBEN_W<'_, BK1CTRL1_SPEC> {
        SYNCBEN_W::new(self, 8)
    }
    #[doc = "Bit 9 - NWAIT polarity"]
    #[inline(always)]
    pub fn nwpol(&mut self) -> NWPOL_W<'_, BK1CTRL1_SPEC> {
        NWPOL_W::new(self, 9)
    }
    #[doc = "Bit 10 - Wrapped enable"]
    #[inline(always)]
    pub fn wrapen(&mut self) -> WRAPEN_W<'_, BK1CTRL1_SPEC> {
        WRAPEN_W::new(self, 10)
    }
    #[doc = "Bit 11 - Wait timing configuration"]
    #[inline(always)]
    pub fn nwtcfg(&mut self) -> NWTCFG_W<'_, BK1CTRL1_SPEC> {
        NWTCFG_W::new(self, 11)
    }
    #[doc = "Bit 12 - Write enable"]
    #[inline(always)]
    pub fn wen(&mut self) -> WEN_W<'_, BK1CTRL1_SPEC> {
        WEN_W::new(self, 12)
    }
    #[doc = "Bit 13 - NWAIT in synchronous transfer enable"]
    #[inline(always)]
    pub fn nwsen(&mut self) -> NWSEN_W<'_, BK1CTRL1_SPEC> {
        NWSEN_W::new(self, 13)
    }
    #[doc = "Bit 14 - Read-write timing different"]
    #[inline(always)]
    pub fn rwtd(&mut self) -> RWTD_W<'_, BK1CTRL1_SPEC> {
        RWTD_W::new(self, 14)
    }
    #[doc = "Bit 15 - NWAIT in asynchronous transfer enable"]
    #[inline(always)]
    pub fn nwasen(&mut self) -> NWASEN_W<'_, BK1CTRL1_SPEC> {
        NWASEN_W::new(self, 15)
    }
    #[doc = "Bits 16:18 - CRAM page size"]
    #[inline(always)]
    pub fn crpgs(&mut self) -> CRPGS_W<'_, BK1CTRL1_SPEC> {
        CRPGS_W::new(self, 16)
    }
    #[doc = "Bit 19 - Memory write mode control"]
    #[inline(always)]
    pub fn mwmc(&mut self) -> MWMC_W<'_, BK1CTRL1_SPEC> {
        MWMC_W::new(self, 19)
    }
}
#[doc = "SRAM/NOR-Flash chip-select control register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`bk1ctrl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bk1ctrl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BK1CTRL1_SPEC;
impl crate::RegisterSpec for BK1CTRL1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bk1ctrl1::R`](R) reader structure"]
impl crate::Readable for BK1CTRL1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`bk1ctrl1::W`](W) writer structure"]
impl crate::Writable for BK1CTRL1_SPEC {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets BK1CTRL1 to value 0x30db"]
impl crate::Resettable for BK1CTRL1_SPEC {
