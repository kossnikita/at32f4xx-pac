...
pub type R = crate::R<RFDTL0_SPEC>;
...
pub struct RFDTL0_SPEC;
impl crate::RegisterSpec for RFDTL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rfdtl0::R`](R) reader structure"]
impl crate::Readable for RFDTL0_SPEC {}
#[doc = "`reset()` method sets RFDTL0 to value 0"]
impl crate::Resettable for RFDTL0_SPEC {
