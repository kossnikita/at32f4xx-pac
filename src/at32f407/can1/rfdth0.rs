...
pub type R = crate::R<RFDTH0_SPEC>;
...
pub struct RFDTH0_SPEC;
impl crate::RegisterSpec for RFDTH0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rfdth0::R`](R) reader structure"]
impl crate::Readable for RFDTH0_SPEC {}
#[doc = "`reset()` method sets RFDTH0 to value 0"]
impl crate::Resettable for RFDTH0_SPEC {
